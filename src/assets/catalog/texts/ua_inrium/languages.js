...
export const langs = {
  ...
  common_details: "Торгова мова людей. Майже всі розумні істоти можуть розуміти і говорити Спільною мовою, хоча вони і можуть вдавати, що не розуміють його.",

  halfling: "напівросликова",

  halfling_details: "Луйрік. Не є секретним, але напіврослики не поспішають ділитися ним з іншими. Пишуть вони мало, і майже не створили власної літератури, але усні перекази серед напівросликів дуже поширені. Використовує символи із Спільного.",
