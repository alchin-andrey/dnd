...
export const protection_from_evil_and_good_expanded = 'Поки чари активні, одна згодна істота, яку ви торкнулися, захищена від певного виду істот: аберації, породження, небожителі, немертві, феї чи елементали.<br/><br/>' + 
...
export const detect_evil_and_good_expanded = 'Поки чари активні, ви знаєте, чи є в межах 30 футів від вас аберації, породження, небожителі, немертві, феї або елементали, а також їхнє розташування. Крім того, ви знаєте, чи є в межах 30 футів від вас місце або предмет, який був магічно освячений або опоганений.<br/><br/>' + 
...
'<span class="rare-text">* Ви можете один раз створити чари Пристріт, використовуючи чарунку. Ви не можете зробити це повторно, поки не закінчите тривалий відпочинок.</span>';
...
export const see_invisibility_expanded = 'Поки чари активні, ви бачите невидимих істот і предмети, наче вони видимі, і ваш зір тягнеться на Ефірний План. Ефірні істоти та предмети виглядають примарними та напівпрозорими.<br/><br/>' + 
...
'Поки чари активні, ви захищені від певного виду істот: аберації, породження, небожителі, немертві, феї чи елементалі.<br/><br/>' + 
...
export const holy_nimbus_details = 'Випромінювати сонячне світло і завдавати ним пошкодження. Отримати <span class="buff">перевагу</span> на Випробування від чарів породжень та немертвих.';
...
'Крім того, протягом цього часу ви робите з перевагою Випробування від чарів, створених породженнями і немертвими.<br/><br/>' + 
...
'Чари дають згодній істоті, до якої ви доторкнулися, здатність бачити речі такими, якими вони є насправді. Поки чари активні, ця істота має істинний зір, бачить потаємні двері, приховані магією, його зір простягається на Ефірний План, і все це в межах 120 футів.<br/><br/>'+
