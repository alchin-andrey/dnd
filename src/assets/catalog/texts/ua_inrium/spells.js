...
'Фізична взаємодія з образом дає зрозуміти, що це ілюзія, тому що крізь неї все проходить. Істоти, що досліджують образ дією, можуть визначити, що це ілюзія, зробивши успішну перевірку Розслідування проти складності ваших чарів. Якщо істота розпізнає ілюзію, вона може бачити крізь неї, і всі інші сенсорні ефекти ілюзії теж притуплюються.<br/><br/>'+
...
export const mordenkainens_private_sanctum_expanded = 'Ви магічно убезпечуєте область в межах відстані. Ця область може бути кубом із розміром сторони від 5 до 100 футів. Ці чари існують усю тривалість або поки ви не відпустите їх дією. Коли ви створюєте ці чари, то вирішуєте, які гарантії безпеки надають чари, обираючи будь-які або всі з наступних властивостей:<br/><br/>'+
