...
'• Потужна погань, небожителі, немертві, феї та елементали<br/>'+
...
export const divine_sense_details = 'Дізнатися про місцезнаходження всіх небожителів, немертвих, погані, освячених і осквернених місць і предметів у межах дальності.';
...
'Ви можете відкрити свою свідомість для виявлення таких сил. Ви до кінця свого наступного ходу знаєте місцезнаходження всіх небожителів, немертвих та погані в межах 60 футів, що не мають повного укриття. Ви знаєте тип (погань, небожитель, немертвий) будь-якої істоти, чию присутність ви відчуваєте, але не можете визначити, хто це конкретно.<br/><br/>' +  
...
export const paladin_divine_smite_details = 'При влучанні ближньою зброєю завдати додаткове пошкодженя. Пошкодження збільшується на 1d8, якщо ціль — немертвий або погань.';

export const paladin_divine_smite_expanded = 
'Якщо ви влучаєте по цілі атакою ближньою зброєю, ви можете витратити одну чарунку для нанесення цілі пошкодження світлом, який додасться до пошкодження від зброї. Додаткове пошкодження дорівнює 2d8 за слот 1 рівня, плюс 1d8 за кожен рівень чарунки вище за перший, до максимуму 5d8. Пошкодження збільшується на 1d8, якщо ціль — немертвий або погань, до максимуму 6d8.';
...
export const spare_the_dying_expanded = 'Ви торкаєтеся живої істоти, яка має 0 хітів. Воно стає стабілізованим. ці чари не має жодного ефекту на немертвих і конструкти.';
...
export const protection_from_evil_and_good_details = 'Аберації, погань, небожителі, немертві, феї чи елементали атакують союзника з перешкодою, і не можуть Перелякати, Зачарувати чи зробити Одержимим.';

export const protection_from_evil_and_good_expanded = 'Поки чари активні, одна згодна істота, яку ви торкнулися, захищена від певного виду істот: аберації, погань, небожителі, немертві, феї чи елементали.<br/><br/>' + 
...
export const healing_word_expanded = 'Істота на ваш вибір, видима в межах дистанції, відновлює кількість здоровʼя, що дорівнює 1d4 + ваш модифікатор базової Здібності. Ці чари не мають жодного ефекту на немертвих і конструктів.<br/><br/>' + 
...
export const cure_wounds_expanded = 'Істота, до якої ви доторкаєтесь, відновлює кількість здоровʼя, що дорівнює 1d8 + ваш модифікатор базової Здібності. Ці чари не мають жодного ефекту на немертвих і конструктів.<br/><br/>' + 
...
export const detect_evil_and_good_details = 'Знайти аберації, погань, небожителів, немертвих, фей, елементалей або освячені/нечисті предмети.';

export const detect_evil_and_good_expanded = 'Поки чари активні, ви знаєте, чи є в межах 30 футів від вас аберації, погань, небожителі, немертві, феї або елементали, а також їхнє розташування. Крім того, ви знаєте, чи є в межах 30 футів від вас місце або предмет, який був магічно освячений або опоганений.<br/><br/>' + 
...
'Для того щоб істота потрапила під дію чарів, потрібно щоб кількість її поточних пунктів здоровʼя не перевищувала суму, що залишилася. Немертві і істоти, що мають імунітет до Зачарування, не підпадають під дію цих чарів.<br/><br/>' + 
...
export const prayer_of_healing_expanded = 'Кожна із шести істот на ваш вибір, видимих в межах дистанції, відновлює кількість здоровʼя, що дорівнює 2d8 + модифікатор вашої базової Здібності. Ці чари не мають жодного ефекту на немертвих і конструктів.<br/><br/>' + 
...
export const gentle_repose_expanded = 'Ви доторкаєтеся до трупа чи інших останків. Поки чари активні, ціль захищена від розкладання і не може стати немертвим.<br/><br/>' + 
...
export const divine_channel_devotion_2_details = 'Вигнати погань та немертвих в межах дистанції, які бачать чи чують вас і провалили Випробування:<br/>' +
...
export const divine_channel_vengence_1_details = '😱 Перелякати істоту, що провалила Випробування. Погань або немертвий отримує <span class="buff">перешкоду</span> на Випробування. Пошкодження по істоті знімає ефект.';

export const divine_channel_vengence_1_expanded = 
'Ви Основною дією демонструєте свій священний символ і вимовляєте молитву-вирок використовуючи Божественний канал. Виберіть одну істоту в межах 60 футів, яку можете бачити. Ця істота повинна пройти Випробування Мудрості, якщо не має імунітету до Переляку. Погань і немертві роблять це Випробування з перешкодою. Якщо Випробування провалене, істота стає Переляканою на 1 хвилину, або поки не отримає пошкодження. Поки істота Перелякана, її швидкість дорівнює 0, і вона не отримує жодних бонусів до швидкості. Якщо спаскидок був успішний, швидкість істоти на 1 хвилину, або поки вона не отримує пошкодження, зменшується вдвічі.<br/><br/>' + divine_channel_expanded;
...
export const primeval_awareness_details = 'Визначити без деталей, чи є в межах дальності аберації, дракони, погань, небожителі, немертві, феї та елементалі.';

export const primeval_awareness_expanded = 'Ви можете Основною дією витратити одну чарунку, щоб зосередитися на пізнанні простору навколо себе. Протягом 1 хвилини за кожний рівень використаної чарунки ви можете відчути присутність наступних видів істот у межах 1 милі (або в межах 6 миль, якщо ви перебуваєте в обраній місцевості): аберації, дракони, погань, небожителі, немертві, феї та елементали. Це вміння не розкриває розташування та кількість істот.';
...
export const protection_from_evil_and_good_paladin_details = 'Аберації, погань, небожителі, немертві, феї чи елементали атакують вас з перешкодою, і не можуть Перелякати, Зачарувати чи зробити Одержимим.';
...
'Поки чари активні, ви захищені від певного виду істот: аберації, погань, небожителі, немертві, феї чи елементалі.<br/><br/>' + 
...
export const holy_nimbus_details = 'Випромінювати сонячне світло і завдавати ним пошкодження. Отримати <span class="buff">перевагу</span> на Випробування від чарів погані та немертвих.';
...
'Крім того, протягом цього часу ви робите з перевагою Випробування від чарів, створених поганню і немертвими.<br/><br/>' + 
...
export const control_undead_expanded = 'Ви можете магією підкорити собі немертвого, навіть якщо він створений іншим магом. Ви можете вибрати одного немертвого в межах 60 футів від себе, якого можете бачити. Ця істота має пройти Випробування Харизми проти складності ваших чарів. Якщо воно успішне, ви не можете більше використовувати це вміння на цю ціль. Якщо воно провалене, ціль стає дружньою до вас і підкоряється вашим командам, доки ви не використовуєте це вміння знову. Розумні немертві керуються подібним способом набагато важче.<br/><br/>'+
...
'Ці чари не мають ефекту на немертвих.<br/><br/>'+
...
'Ці чари не мають жодного ефекту на немертвих і конструктів.<br/><br/>'+
...
'Ці чари не можуть оживити немертвих. Ці чари зцілюють всі рани, але не відновлює відсутні частини тіла. Якщо істота не має життєво важливих частин тіла — наприклад, голови — чари автоматично провалюються.<br/><br/>'+
...
export const speak_with_dead_expanded = 'Ви даєте подобу життя і свідомості трупу, обраному в межах дистанції, дозволяючи йому відповідати на запитання, що задаються. У трупа має бути рота, і він не може бути немертвим. Чари провалюються, якщо цей труп був ціллю цих чарів протягом останніх 10 днів.<br/><br/>'+
...
export const animate_dead_expanded = 'Ці чари створюють прислужливого немертвого. Виберіть купу кісток або труп гуманоїду Середнього або Маленького розміру в межах дистанції. Ваші чари наділяють ціль мерзенною подобою життя, роблячи з нього істоту-немертвого. Ціль стає Скелетом, якщо ви вибирали кістки або Зомбі, якщо ви вибрали труп.<br/><br/>'+
...
export const hallow_details = 'Створити область, неможливу для входу та взаємодії погані, небожителів, немертвих, фей та елементалей, що має один з ефектів:<br/>'+
...
export const magic_circle_details = 'Створити область, умовно непроникну для погані|небожителів|немертвих|фей|єлементалей. Ці істоти атакують із перешкодою по істотах в області. Також у істот в області імунітет до Зачарування, Переляку, Одержимості. Можна перетворити навпаки на пастку для обраного виду істот.';

export const magic_circle_expanded = 'Ви створюєте з магічної енергії циліндр з радіусом 10 футів і заввишки 20 футів із центром на точці на підлозі, видимої в межах дистанції. Там, де циліндр перетинає підлогу або іншу поверхню, зʼявляються руни, що світяться. Виберіть один або кілька видів істот з наступного списку: погань, небожителі, немертві, феї або елементалі. Коло діє на обраних істот так:<br/><br/>'+
...
export const mass_healing_word_expanded = 'Ви вимовляєте слова відновлення, і до шести істот на ваш вибір, видимих в межах дистанції, відновлюють здоровʼя в кількості, що дорівнює 1d4 + ваш модифікатор базової характеристики. Ці чари не мають жодного ефекту на немертвих і конструктів.<br/><br/>'+
...
export const fabricate_details = 'Перетворити сиру матерію на предмети з того ж матеріалу. Для виготовлення з металічної,камʼяної тощо матерії — область менша, куб 5ф.';
...
export const otilukes_resilient_sphere = "Пружна куля";
