...
'Якщо здоровʼя цілі опускається до 0, поки чари активні, ви можете у свій наступний хід Бонусною дією вибрати метою нову істоту.<br/><br/>' + 
...
'Якщо ви накладаєте ці чари, використовуючи слот 3 рівня або вище, ви можете зробити метою одну додаткову істоту за кожен рівень чарунки вище за другий.';
...
export const crown_of_madness_details = 'Змусити мету, що провалила Випробування, атакувати кого скажете. Потрібно витрачати Основну дію кожен хід на підтримку діі чарів.';
...
export const rangers_companion_expanded = 'Ви отримуєте звіра-супутника, який супроводжує вас під час пригод і навчений боротися разом з вами. Виберіть звіра, з розміром не більшим за Середній, небезпека якого дорівнює 1/4 або нижче. Додайте свій бонус майстерності до Броні, кидків атаки та пошкодження звіра, а також до Випробувань і Навичок, якими він володіє. Максимум його здоровʼя дорівнює його звичайному максимуму або вашому чотирикратному рівню рейнджеру, залежно від того, що вище. Подорожуючи обраною місцевістю тільки вдвох зі звіром, ви можете пересуватися непомітно в нормальному темпі. Як будь-які інші істоти, звір може витрачати Реген під час короткого відпочинку.<br/><br/>'+
...
'Ви або згодна істота, якої ви торкаєтеся, входите в транс, стаючи посильним. Перебуваючи у трансі, посильний усвідомлює своє оточення, але не може здійснювати дії і переміщатися. Якщо ціль спить, посильний зʼявляється у її сні і може розмовляти з нею, поки та спить, і поки чари активні. Посильний може формувати оточення сну, створюючи місцевість, предмети та інші образи. Посильний може будь-коли вийти з трансу, закінчивши ефект цих чарів. Після пробудження ціль чудово памʼятає сон. Ви можете зробити посильного кошмарним для мети. У цьому випадку посильний може передати послання не довше десяти слів, і ціль зобовʼязана здійснити Випробування Мудрості.<br/><br/>'+
...
'• Поки мета проклята, ваші атаки та чари завдають їй додаткової шкоди некротичною енергією 1d8. Чари Зняття прокляття закінчує цей ефект.<br/><br/>'+
