...
export default {
  ...
  authors:
    ...
    "<br/>По любьім темам об єтом сайте, пишите Диме." +
    ...
    '<br/>Безжалостное и жестокое вторжение ₚосии в Украину продолжается, поєтому 80% донатов мьі отправляем в фонд "<a target="_blank" href="https://savelife.in.ua">Повернись Живим</a>".',
