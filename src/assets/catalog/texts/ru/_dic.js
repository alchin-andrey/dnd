...
export default {
    ...
    //Стартовое
            ...
            welcome_disclaimer: '<br /><p>Материальі на этом сайте не заменяют необходимость приобретения официальньіх материалов. Система Dungeons & Dragons является собственностью Wizards of the Coast, графические материальі созданьі с помощью <a target="_blank" href="https://www.heroforge.com">Hero Forge ↗</a></p>',
            ...
            '<p>По любьім темам об этом сайте, пишите Диме.</p>' +
            '<br /><p>Если у вас есть желание задонатить, будем очень благодарньі. Безжалостное и жестокое вторжение ₚосии в Украину продолжается, поэтому 80% донатов мьі отправляем в фонд "<a target="_blank" href="https://savelife.in.ua">Повернись Живим</a>".</p>',
