...
export default {
  ...
  spell_cleric: "заклинание [1] жреца",
  spell_druid: "заклинание [1] друида",
  spell_warlock: "заклинание [1] колдуна",
  spell_sorcerer: "заклинание [1] чародея",
  spell_wizard: "заклинание [1] волшебника",
  spell_bard: "заклинание [1] барда",

  feat_skilled: "Одаренньій",
  feat_skilled_details: "Вы получаете владение любой комбинацией из трёх навыков или инструментов на ваш выбор.",
