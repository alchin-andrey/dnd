...
export default {
  ...
  feat_custom_stalker:"Вы - эксперт в выслеживании добычи. Во время охоты вы чувствуете себя более уверенно, чем дома, и ваша добыча редко ускользает от вас.<br/><br/>" + races.rare,
