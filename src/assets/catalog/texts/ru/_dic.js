...
export default {
  ...
  feat_resilient_details: "Вьі сфокусировались на одной из ваших характеристик. Ее базовое значение увеличивается на 1, и вьі получаете +мастерство к Испьітанию этой характеристики.",
