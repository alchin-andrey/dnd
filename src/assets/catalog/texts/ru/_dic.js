...
export default {
  ...
  welcome_disclaimer:
    '<br/>Материальі на єтом сайте не заменяют необходимость приобретения официальньіх материалов. Система Dungeons & Dragons является собсвенностью Wizards of the Coast, графические материальі созданьі с помощью <a target="_blank" href="https://www.heroforge.com">Hero Forge ↗</a>',
  ...
  // lobby_button: "Что за D&D такое и где найти Мастера?",

  //   lobby_base: "база",

  //   lobby_what_is_it: "Что єто такое?",
  
  //   lobby_what_is_it_details:
  //   'В отличие от сюжетных компьютерных игр, игроки в Dungeons & Dragons могут делать действительно что угодно и влиять на мир игры, создавая непредсказуемые ситуации и неожиданные последствия.'+
  
  //   '<br/><br/>Сюжеты, типичные или авторские, бывают такие:'+
  
  //   '<br/><br/>One-shot — Краткая история на 1-2 игры.'+
  
  //   '<br/><br/>Module — Средняя история, которую можно играть в течение нескольких сеансов, обычно 3-5 игр.'+
  
  //   '<br/><br/>Campaign — Долговременная история, которая может длиться несколько месяцев или даже лет.'+
  
  //   '<br/><br/>Удачный ваншот легко может превратиться в Модуль, или даже на Кампейн.'+
  
  //   '<br/><br/>D&D способна понравиться каждому. Это доказывает ее всемирную популярность на протяжении уже 50+ лет, несмотря на сложность начала (до появления нашего сайта).',

  //   lobby_how_it_works: "Как проходит игра?",

  //   lobby_how_it_works_details_1: "Вы выбираете Мастера и связываетесь с ним",
  //   lobby_how_it_works_details_1_1: ", договариваетесь по часу, месту, количеству людей от вас и др. Обычно это 3-4 человека и 3-4 часа.",

  //   lobby_how_it_works_details_2: "Мастер формирует группу, и говорит, какого уровня нужно создать персонажа. Обычно это 3й.",
  
  //   lobby_how_it_works_details_3: "Вы заранее создаете своего персонажа и отправляете его Мастеру.",
  
  //   lobby_how_it_works_details_4: "Мастер рассказывает основы, просить игроков немного рассказать о своих персонажах и начинает погружать вас в сюжет.<br/><br/>——",
  
  //   lobby_how_it_works_details_5: "Мастер описывает окружение и ситуацию.",
  
  //   lobby_how_it_works_details_6: "Игроки, взаимодействуя между собой (или нет) говорят что они хотят сделать/сказать их персонажи.",
  
  //   lobby_how_it_works_details_7: "Мастер просит бросить конкретные кубики, и на основе результата броска описывает последствия, из которых исходит новая ситуация для реакции игроков.",
};  
