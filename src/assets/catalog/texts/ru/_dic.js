...
export default {
  ...
  authors:
    ...
    '<br/>Безжалостное и жестокое вторжение ₚосии в Украину продолжается, поєтому 20% донатов мьі отправляем в фонд "<a target="_blank" href="https://savelife.in.ua">Повернись Живим</a>".',
