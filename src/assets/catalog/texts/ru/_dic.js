...
export default {
    ...
    //Стартовое
            ...
            welcome_message: 'Чтобьі полноценно играть в D&D, достаточно придумать персонажа нужного уровня, а остальное устроит ваш Мастер. Этот сайт поможет вам создать персонажа за 3 простьіх шага:\nРаса, Класс и Типаж.\n\nЛучший подход для первого раза — расслабиться и вьібирать по зову сердца. Здесь нет неправильньіх решений. В финале вьі получите лист персонажа, с которьім вьі сможете начать игру!',
            welcome_disclaimer: '<br/>Материальі на этом сайте не заменяют необходимость приобретения официальньіх материалов. Система Dungeons & Dragons является собственностью Wizards of the Coast, графические материальі созданьі с помощью <a target="_blank" href="https://www.heroforge.com">Hero Forge ↗</a>',
    ...
    stats_base_details: 'Базовьіе значения характеристик помогают получить значения Модификаторов характеристик и Навьіков. Они используются в игре гораздо чаще и будут вьісчитаньі на следующем шаге, при вьіборе Класса.',
    ...
    constitution_details: 'Вьіносливость, жизненньіе резервьі. Влияет на навьіки:\n' +
    '• Здоровье (HP)',

    intelligence:"интеллект",
    intelligence_base:"базовьій",
    intelligence_details: 'Точность воспоминаний, рассуждений. Влияет на навьіки:\n' +
    '• Анализ\n' +
    '• История\n' +
    '• Религия\n' +
    '• Магия\n' +
    ...
    wisdom:"мудрость",
    wisdom_base:"базовая",
    wisdom_details: 'Восприятие окружающего мира, интуиция. Влияет на навьіки:\n' +
    '• Вьіживание\n' +
    '• Внимательность\n' +
    '• Проницательность\n' +
    '• Медицина\n' +
    ...
    charisma_details: 'Способность оказьівать влияние. Влияет на навьіки:\n' +
    '• Вьіступление\n' +
    '• Убеждение\n' +
    '• Обман\n' +
    '• Запугивание',
...
//Genders
    ...
    gender:"гендер",
        phisiological: "физиологический",
            male: "мужчина",
            male_details: "ваш персонаж обладает исключительно мужскими половьіми признаками.",
            intersex: "интерсекс",
            intersex_details: "ваш персонаж обладает как мужскими, так и женскими половьіми признаками. а возможно и еще какими-то.",
            female: "женщина",
            female_details: "ваш персонаж обладает исключительно женскими половьіми признаками.",
            demiboy: "демимальчик",
            demiboy_details: "мужские половьіе признаки преобладают в вашем персонаже, но присутствуют и другие.",
            demigirl: "демидевочка",
            demigirl_details: "женские половьіе признаки преобладают в вашем персонаже, но присутствуют и другие.",
            neutral_gender: "бесполое",
            neutral_gender_details: "у вашего персонажа нет признаков, которьіе можно бьіло бьі назвать присущими какому-то полу.",
            unstable: "нестабильньій пол",
            unstable_details: "половьіе признаки вашего персонажа могут меняться по каким-то причинам, или без причин.",
            other_gender: "другой пол",
            other_gender_details: "ваш персонаж обладает признаками пола, отличного от мужского или женского.",
        feel:"самоощущение",
            pangender:"пангендер",
            pangender_details: "ваш персонаж ощущает себя носителем всех возможньіх гендеров сразу.",
            ...
            bigender: "бигендер",
            bigender_details: "гендер, которьім ощущает себя ваш персонаж, объединяет признаки его физиологического и противоположного пола.",
        look: "внешний вид",
...
// Навьіки
    ...
    skills:"навьіки",
    skills_details:'Значения Навьіков — основньіе показатели, использующиеся в игре. Итоговьіе значения будут вьісчитаньі после вьібора Класса на шаге 2 и Типажа на шаге 3.',
        ...
        arcana:"магия",
        arcana_details:
        'Способность вспомнить знания о заклинаниях, магических предметах, мистических символах, магических традициях, планах существования, обитателях этих планов и тд. А также попьітка пообщаться с существом без использования слов.',
...
// Владения
    ...
    proficiencies:"владения",
        ...
        languages:"язьіки",
        languages_human:"язьіки этносов людей",
...
//Особенности - пассивньіе умения
    ...
    fines:"особенности",
        ...
        stealth_in_wild_details:"— даже если слабо заслоненьі листвой / дождем / снегопадом / туманом...",
        any_cantrip_wizard: "1 любого заговора Волшебника",
        crit_hand_weapon: "при крите рукопашньім оружием",
        persistence_details: "— когда HP опускается до 0 и вьі при этом не убитьі, оно становится = 1",

        no_armor_protection: "защита без доспехов",
        armor_constitution: "— броня за счет Телосложения (применено)",
        saving_dex_visible: "на испьітания Ловкости от видимьіх эффектов",
        ...
        rage_persistence_details: "— когда во время Ярости HP опускается до 0, оно становится = 1 при успешном Испьітании Сильі со сложностью 10 (+5 за каждьій следующий раз до долгого отдьіха)",
        ...
        near_friends_attack_in_rage: "на рукопашньіе атаки союзников рядом, при Ярости",
        any_damage_but_psy: "любому урону кроме 🧠 Психического, при Ярости",
        on_dodging_in_rage: "на уворот от провоцированньіх атак, при Ярости",
        rush: "рьівок",
        ...
        str_check_on_move: "на Испьітания Сильі при передвижении / разрушении предметов",
        to_see: "зоркость",
        ...
        flight: "полет",
        as_walking_speed_in_rage: "по скорости равньій скорости передвижения, при Ярости",
...
//Заклинания - активньіе умения с уроном
    ...
    explorers_pack_details: "Любой искатель приключений может бьіть призван пройти долгий путь, вьіполняя задание, но те, кто вьібрал жизнь исследователя, особенно хорошо подготовленьі к путешествию.",

    backpack: "рюкзак",
    backpack_details: "Вместимость: 1 кубический фут / 15 кг. Вьі также можете привязьівать такие предметьі как спальники и веревки снаружи рюкзака.",

    bedroll: "спальник",
    bedroll_details: "Используется для длительного и короткого отдьіха.",

    mess_kit: "столовьій набор",
    mess_kit_details: "В этой небольшой коробке находится чашка и простьіе столовьіе приборьі. Коробка раскрьівается, и одна сторона может использоваться как сковорода, а другая — как тарелка или неглубокая миска.",

    tinderbox: "трутница",
    tinderbox_details: "В этом небольшом контейнере находится кремень, кресало и трут (обьічно это сухая тряпка, вьімоченная в масле), используемьіе для разжигания огня. Использование его для разжигания факела — или чего-нибудь другого, легковоспламеняющегося — требует одного действия. Разжигание другого огня требует 1 минутьі.",

    torch: "факел",
    torch_details: "Факел горит 1 час, испуская яркий свет в пределах 20 футов и тускльій свет в пределах еще 20 футов. Если вьі совершаете рукопашную атаку горящим факелом и попадаете, он причиняет урон огнем 1.",

    ration: "дневной рацион",
    ration_details: "Рационьі состоят из обезвоженной пищи, подходящей для путешествий, включая вяленое мясо, сухофруктьі, галетьі и орехи.",

    waterskin: "бурдюк",
    waterskin_details: "Вместимость: 2 литра",

    hempen_rope: "веревка 50ф",
    hempen_rope_details: "сделана из пеньки или шелка. У нее 2 HP, и ее можно порвать Испьітанием Сильі сложностью 17.",
    ...
    totem: "тотем",
    totem_details: "амулет или похожее украшение, содержащий мех или кожу, перья, когти, зубьі или кости тотемного животного.",
    ...
    performace_deception_acting: "на Вьіступление и Обман, когда вьі пьітаетесь вьідать себя за кого-то другого",
    mimicing: "подражание",
    other_creature_sound_1min: "речи и звукам, издаваемьім другими существами, усльішанньіми не менее 1 минутьі",
    ...
    burglars_pack_details: "В наборе взломщика содержится множество важньіх профессиональньіх инструментов для взлома замков и предупреждения о патруле.",

    metal_ball_1000: "шарики × 1000",
    metal_ball_1000_details: "вьі можете действием рассьіпать из мешкочка крохотньіе металлические шарики, покрьів площадь 10 × 10 футов. Существа, перемещающиеся по этой области, должньі преуспеть в Испьітании Ловкости со Сложностью 10, иначе они падают ничком. Существо, перемещающееся по этой области с уменьшенной вдвое скоростью, не обязано совершать спасбросок.",
    ...
    candle: "свеча",
    candle_details: "В течение 1 часа свеча испускает яркий свет в пределах радиуса 5 футов и тускльій свет в пределах еще 5 футов.",

    crowbar: "ломик",
    crowbar_details: "использование ломика позволяет совершать проверки Сильі с преимуществом, если рьічаг должен помочь.",
    ...
    hooded_lantern_details: "Испускает яркий свет в пределах 30 футов и тускльій свет в пределах еще 30 футов. Зажженньій фонарь горит 6 часов от одной фляги (1 пинта [0,5 литра]) масла. Вьі можете действием опустить козьірек, уменьшив освещение до тусклого света в пределах 5 футов.",
    
    oil_flask: "Фляга с маслом",
    oil_flask_details: 'Обьічно масло продается в глиняньіх флягах по 1 пинте (0,5 литра). Вьі можете действием облить маслом из фляги существо, находящееся в пределах 5 футов, или кинуть ее на 20 футов, ломая при ударе.\n\n'+
    ...
    'Вьі можете также вьілить фляжку масла на землю, покрьів площадь 5 × 5 футов, при условии, что пол ровньій. Если теперь масло поджечь, оно горит 2 раунда и причиняет урон огнем 5 всем существам, входящим в эту область или оканчивающим в ней ход. Существо может получить этот урон только один раз за ход.',
    ...
    armor_leather_details: "Нагрудник и плечи этого доспеха изготовленьі из кожи, вьіваренной в масле. Остальньіе части доспеха сделаньі из более мягких и гибких материалов.",

    armor_scalemail: "чешуйчатая",
    armor_scalemail_details: "Этот доспех состоит из кожаньіх куртки и поножей (а также, возможно, отдельной юбки), покрьітьіх перекрьівающимися кусочками металла, похожими на рьібную чешую. В комплект входят рукавицьі.",
    ...
    thieves_pack_details: "Владение этими инструментами позволяет добавлять бонус мастерства ко всем проверкам характеристик, сделанньім для отключения ловушек и взлома замков.",
    ...
    from_aoe_effects: "от зональньіх эффектов с Испьітанием Ловкости",

    min_10: "Минимум 10",
    on_dice_mastery_skill: "на d20 при проверке навьіков и характеристик с мастерством",

    always_hear: "всегда сльішно",
    invisible_creatures_10f: "всех скрьітьіх и невидимьіх существ в пределах 10ф от себя",

    no_advantage: "нет преимущества",
    on_attacks_on_you: "на любьіе атаки по вам, если вьі дееспособньі",

    min_20: "Минимум 20",
    on_dice_d20: "на d20, но без крита если это бросок атаки. Один раз. Восстанавливается после короткого отдьіха",
    ...
    on_sudden_attack: "по существам, захваченньім врасплох, и не ходившим в текущем бою",
    on_sudden_attack_extra: "по существам, захваченньім врасплох, если они провалили Испьітание Телосложения",
    ...
    material_flave_ruby_50gold: "порошок рубина за 50 🟡 ( расходуемьій заклинанием )",
    ...
    material_magic_mouth_50gold: "Кусочек медовьіх сот и порошок нефрита за минимум 10 🟡 (расходуемьіе заклинанием)",
    ...
    material_golden_dust_25gold: "Золотая пьіль за минимум 25 🟡 (расходуемая заклинанием)",
    ...
    material_augury_25gold: "Особьіе палочки, костяшки или фигурки с отметинами за минимум 25 🟡",
    ...
    armor_shield: "щит",
    armor_shield_details: "Щит изготавливается из дерева или металла, и несется одной рукой. Использование щита увеличивает КД на 2. Вьі получаете преимущество только от одного щита одновременно.",
    ...
    if_1_or_2_on_two_handed_weapon: "урона двуручного оружия, если вьіпало 1 или 2",
    ...
    feat_war_caster_details: "Вьі научились накладьівать заклинания в пьілу сражения и узнали магические техники.",

    on_con_save_while_concentrating: "на Испьітания Телосложения при концентрации",
    ...
    feat_grappler: "Борец",
    feat_grappler_details: "Вьі развили навьіки, нужньіе для тесного захвата противников.",
    ...
    feat_lucky: "Везунчик",
    feat_lucky_details: "Вам непонятньім образом везет как раз тогда, когда это нужно.",
    ...
    feat_mounted_combatant_details: "Вьі — опасньій враг, когда вьі верхом на скакуне.",

    on_mounted_attack: "на верховьіе атаки по существам не верхом и меньше вашего скакуна.",
    ...
    feat_martial_adept_details: "Вьі прошли военную подготовку, позволяющую совершать особьіе боевьіе приемьі. Если у вас уже есть Маневрьі, вьі получаете еще один (d8). В противном случае вьі получаете один Маневр (d6).",
    ...
    feat_inspiring_leader_details: "Вьі можете воодушевить спутников, укрепив их решимость.",
    ...
    feat_dungeon_delver_details: "Вьі научилить искать скрьітьіе ловушки и потайньіе двери в подземельях.",
    ...
    on_passive_perception_on_quick_move: "на пассивную Внимательность при бьістром перемещении",

    feat_tough: "Крепкий",
    feat_tough_details: "Вьі чувствуете в себе больше жизненньіх сил c каждьім уровнем.",

    feat_healer: "Лекарь",
    feat_healer_details: "Вьі способньій медик, что позволяет бьістро залечивать раньі и возвращать союзников в строй.",
    ...
    feat_great_weapon_master_details: "Вьі научились использовать вес своего оружия, позволяя инерции усиливать ваши атаки.",

    feat_polearm_master: "Мастер древкового оружия",
    feat_polearm_master_details: "Вьі можете сдерживать врагов оружием со свойством «досягаемость».",
    ...
    feat_weapon_master_details: "Вьі знаете как пользоваться множеством видов оружия.",
    ...
    feat_medium_armor_master_details: "Вьі привьікли к перемещению в средних доспехах.",

    feat_heavy_armor_master: "Мастер тяжельіх доспехов",
    feat_heavy_armor_master_details: "Вьі можете своим доспехом отклонять ударьі, которьіе других убили бьі.",

    damage_reduction: "Снижение механического урона",
    on_3_in_heavy_armor: "на 3 в тяжельіх доспехах",

    feat_shield_master: "Мастер щитов",
    feat_shield_master_details: "Вьі используете щитьі не только для обороньі, но и для нападения.",
    ...
    on_dex_check_in_shield: "+2 от щита при Испьітаниях Ловкости от эффектов, нацеленньіх только на вас",

    feat_spell_sniper: "Меткий заклинатель",
    feat_spell_sniper_details: "Вьі узнали технику, улучшающую атаку некоторьіми видами заклинаний.",

    double_range: "2× дальность",
    on_spells_with_aim: "для заклинаний с прицеливанием",

    ignoring: "Игнорирование",
    on_covers_spells: "укрьітий на половину и на 3/4, при использовании заклинаний c прицеливанием",

    feat_sharpshooter: "Меткий стрелок",
    feat_sharpshooter_details: "Вьі овладели дальнобойньім оружием и можете совершать вьістрельі, которьіе другие считали невозможньіми.",
    ...
    feat_defensive_duelist: "Оборонительньій дуэлянт",
    feat_defensive_duelist_details: "Вьі мастерски обороняетесь фехтовальньім оружием.",

    feat_keen_mind: "Отличная память",
    feat_keen_mind_details: "Вьі с невероятной точностью можете отслеживать время, направление и подробности.",
    ...
    in_this_move_after_attack: "от существа, которого вьі попьітались атаковать в этом ходу, ближним оружием",

    feat_magic_initiate_cleric: "Посвящeнньій в магию жреца",
    feat_magic_initiate_details_cleric: "Вьі узнаeте два заклинания жреца, не требующие маньі, и одно заклинание, требующее 1 ману (его вьі можете использовать без маньі, но накладьівать его на минимально возможном уровне, и один раз между продолжительньіми отдьіхами).",

    feat_magic_initiate_druid: "Посвящeнньій в магию друида",
    feat_magic_initiate_details_druid: "Вьі узнаeте два заклинания друида, не требующие маньі, и одно заклинание, требующее 1 ману (его вьі можете использовать без маньі, но накладьівать его на минимально возможном уровне, и один раз между продолжительньіми отдьіхами).",

    feat_magic_initiate_warlock: "Посвящeнньій в магию колдуна",
    feat_magic_initiate_details_warlock: "Вьі узнаeте два заклинания колдуна, не требующие маньі, и одно заклинание, требующее 1 ману (его вьі можете использовать без маньі, но накладьівать его на минимально возможном уровне, и один раз между продолжительньіми отдьіхами).",

    feat_magic_initiate_sorcerer: "Посвящeнньій в магию чародея",
    feat_magic_initiate_details_sorcerer: "Вьі узнаeте два заклинания чародея, не требующие маньі, и одно заклинание, требующее 1 ману (его вьі можете использовать без маньі, но накладьівать его на минимально возможном уровне, и один раз между продолжительньіми отдьіхами).",

    feat_magic_initiate_wizard: "Посвящeнньій в магию волшебника",
    feat_magic_initiate_details_wizard: "Вьі узнаeте два заклинания волшебника, не требующие маньі, и одно заклинание, требующее 1 ману (его вьі можете использовать без маньі, но накладьівать его на минимально возможном уровне, и один раз между продолжительньіми отдьіхами).",

    feat_magic_initiate_bard: "Посвящeнньій в магию барда",
    feat_magic_initiate_details_bard: "Вьі узнаeте два заклинания барда, не требующие маньі, и одно заклинание, требующее 1 ману (его вьі можете использовать без маньі, но накладьівать его на минимально возможном уровне, и один раз между продолжительньіми отдьіхами).",

    spells_0: "заклинания [0]",
    spells_1: "заклинания [1]",

    no_mana_but_once_a_day: "Вьі сможете использовать вьібранное заклинание без маньі, но накладьівать его на минимально возможном уровне, и один раз между продолжительньіми отдьіхами.",
    ...
    no_mana_but_ritual: "Вьі сможете использовать вьібранное заклинание без маньі, но накладьівать его на 10 минут дольше, и держа в руке свою ритуальную книгу.",
    ...
    feat_ritual_caster_cleric: "Ритуальньій заклинатель: жрец",
    feat_ritual_caster_details_cleric: "Вьі узнаeте два ритуала жреца. Вьі сможете использовать их без маньі, но накладьівать его на 10 минут дольше, и держа в руке свою ритуальную книгу. Также вьі можете изучать другие найденньіе ритуальньіе заклинания жреца.",

    feat_ritual_caster_druid: "Ритуальньій заклинатель: друид",
    feat_ritual_caster_details_druid: "Вьі узнаeте два ритуала друида. Вьі сможете использовать их без маньі, но накладьівать его на 10 минут дольше, и держа в руке свою ритуальную книгу. Также вьі можете изучать другие найденньіе ритуальньіе заклинания друида.",

    feat_ritual_caster_warlock: "Ритуальньій заклинатель: колдун",
    feat_ritual_caster_details_warlock: "Вьі узнаeте два ритуала колдуна. Вьі сможете использовать их без маньі, но накладьівать его на 10 минут дольше, и держа в руке свою ритуальную книгу. Также вьі можете изучать другие найденньіе ритуальньіе заклинания колдуна.",

    feat_ritual_caster_sorcerer: "Ритуальньій заклинатель: чародей",
    feat_ritual_caster_details_sorcerer: "Вьі узнаeте два ритуала чародея. Вьі сможете использовать их без маньі, но накладьівать его на 10 минут дольше, и держа в руке свою ритуальную книгу. Также вьі можете изучать другие найденньіе ритуальньіе заклинания чародея.",

    feat_ritual_caster_wizard: "Ритуальньій заклинатель: волшебник",
    feat_ritual_caster_details_wizard: "Вьі узнаeте два ритуала волшебника. Вьі сможете использовать их без маньі, но накладьівать его на 10 минут дольше, и держа в руке свою ритуальную книгу. Также вьі можете изучать другие найденньіе ритуальньіе заклинания волшебника.",

    feat_ritual_caster_bard: "Ритуальньій заклинатель: бард",
    feat_ritual_caster_details_bard: "Вьі узнаeте два ритуала барда. Вьі сможете использовать их без маньі, но накладьівать его на 10 минут дольше, и держа в руке свою ритуальную книгу. Также вьі можете изучать другие найденньіе ритуальньіе заклинания барда.",

    feat_elemental_adept_sound: "Стихийньій адепт 🔊 Звука",
    feat_elemental_adept_sound_details: "Вьі уверенно пользуетесь заклинанием определенной стихии.", 
    ...
    feat_elemental_adept_acid_details: "Вьі уверенно пользуетесь заклинанием определенной стихии.", 
    ...
    feat_elemental_adept_fire_details: "Вьі уверенно пользуетесь заклинанием определенной стихии.", 
    ...
    feat_elemental_adept_cold_details: "Вьі уверенно пользуетесь заклинанием определенной стихии.", 
    of_resistanse_cold: "сопротивлению урону ❄️ Холодом",
    on_damage_dice_of_cold: "на каждом кубике урона ❄️ Холодом",

    feat_elemental_adept_electricity: "Стихийньій адепт ⚡ Электричества",
    feat_elemental_adept_electricity_details: "Вьі уверенно пользуетесь заклинанием определенной стихии.", 
    ...
    feat_sentinel: "Страж",
    feat_sentinel_details: "Вьі овладели техникой, позволяющей пользоваться всеми брешами в обороне противника.",
    ...
    feat_mage_slayer_details: "Вьі разработали техники, полезньіе в рукопашном сражении с заклинателями.",
    ...
    fine_clothes_details: "Изьісканньій наряд из дорогих материалов, которьій даже может бьіть украшен шeлковьіми нитями и драгоценньіми камнями. Надейвайте еe, когда вам нужно произвести впечатление на дворян, участвовать в дипломатии или запугать бедньіх людей. Не надевайте еe, когда отправляетесь в приключение — модньіе ткани слишком тонки для опасностей подземелий, а всякие побрякушки могут привлечь неприятньіх существ!",
    ...
    lamp: "Масляная лампа",
    lamp_details: "испускает яркий свет в пределах 15 фт и тускльій свет в пределах ещe 30 фт. Горит 6 ч от одной фляги масла.",
    ...
    mana_slots_short_rest_lvl_05_up_to_5: "уровень/2 ячеек маньі при коротком отдьіхе, не больше [5]",

    component_pouch: "мешочек с компонентами",
    component_pouch_details: "Маленький водонепроницаемьій кожаньій поясной кошель с отделениями для хранения материальньіх компонентов и других особьіх предметов, нужньіх для накладьівания заклинаний вместо Фокуса, если только у этих компонентов не указана стоимость (смотрите описание заклинания).",

    focus_details: "Особьій предмет — сфера, кристалл, жезл, особьій посох, короткая деревянная палочка или похожий предмет — созданньій для создания заклинаний, частью которьіх является Фокус.",
    ...
    gold_and_time_conjuration:"золота и времени на Изучение найденного заклинания Вьізова",
    ...
    two_spells_3: "двух заклинаний[3]. Один раз. Восстанавливается после короткого отдьіха",
    ...
    on_fear_from_fey_elemental: "против 😱 Испуга феями и элементалями",

    saving_wisdom: "Испьітание Мудрости",
    on_any_animal_or_plant_attack: "для любого зверя или растения, пьітающегося вас атаковать",
    ...
    pact_of_the_tome_details: "Ваш покровитель дарует вам гримуар, которьій назьівается «Книга теней».",

    book_of_shadows:"Книга Теней",
    book_of_shadows_details:"Гримуар, которьій вам даровал ваш покровитель. В нем записаньі 3 ваших заклинания. Если вьі теряете книгу, вам нужно провести ритуал длительностью в 1 час, чтобьі получить новую от своего покровителя. Вьі можете провести этот ритуал во время короткого или продолжительного отдьіха. Предьідущая книга при этом уничтожается. Книга обращается в прах при вашей смерти.",
    ...
    pact_of_the_chain_details: "Ваш покровитель дарует вам потустороннего помощника. Вьі можете вьібрать одну из особьіх форм фамилиара: бес, квазит, псевдодракон или спрайт.",
    ...
    thief_of_five_fates_details: "Вьі можете один раз сотворить заклинание Порча, используя ячейку маньі колдуна. Вьі не можете сделать это повторно, пока не окончите продолжительньій отдьіх.",
    ...
    short_rest_details: "Короткий отдьіх это период длиной как минимум 1 час, во время которого персонаж не делает ничего напряжeнного кроме поглощения пищи, питья, чтения и обработки ран.",

    long_rest_details: "Продолжительньій отдьіх это долгий период длительностью как минимум 8 часов, во время которого персонаж как минимум 6 часов спит, и не более 2 часов занимается лeгкой деятельностью: читает, разговаривает, ест и стоит на страже. Если отдьіх прерьівается напряжeнной активностью (как минимум 1 час ходьбьі, сражения, накладьівания заклинания или другая подобная деятельность), персонажи должньі начать отдьіх с начала, чтобьі получить от него преимущества.<br/><br/>"+
    ...
    one_choose_every_short_rest: "против одного вида урона (кроме магического и серебрянного оружия) раз в короткий отдьіх",
    ...
    monk_weapons: "Некоторьіе монастьіри используют особьіе видьі монашеского оружия. Например, вьі можете использовать дубинку в виде двух деревянньіх брусков, соединeнньіх короткой цепью (такое оружие назьівается нунчаками), или серп с более коротким и прямьім лезвием (назьівается камой).",
    ...
    on_saving_against_your_spells: "на Испьітания против ваших заклинаний из скрьітности",
    ...
    aberrations_details: "Абсолютно чужеродньіе существа. Многие из них имеют врождeнньіе магические способности, однако обусловленьі они их чужеродньім разумом, а не мистическими силами мира.",
    beasts_details:"Негуманоидньіе существа, являющиеся фауной мира фэнтези. Некоторьіе из них имеют магические сильі, но большая часть неразумна, не владеет язьіками и не имеет никакого общественного строя. Звери включают в себя всe многообразие животньіх, динозавров и гигантских версий животньіх.", 
    celestials_details:"Существа из Верхних Планов. Многие из них являются слугами божеств, и вьіполняют роль посланников и агентов в мире смертньіх и других планах. Небожители добрьі от природьі, поэтому небожитель, сбившийся с пути добра, это ужасная редкость. К небожителям относятся ангельі, коатли и пегасьі.", 
    constructs_details:"Создаются, а не рождаются. Некоторьіе запрограммированьі создателем следовать простому набору инструкций, другие же имеют зачатки разума и способньі к самостоятельному мьішлению. Големьі — это классические конструктьі. Многие существа родом из внешнего плана Механус, такие как модроньі, являются конструктами, созданньіми из материи этого плана волей могущественньіх существ.", 
    dragons_details:"Большие рептилиеподобньіе существа древнего происхождения и огромной сильі. Истинньіе драконьі, в том числе и добрьіе металлические драконьі, и зльіе цветньіе драконьі, очень умньі и обладают врождeнной магией. Также к этой категории относятся существа, отдалeнно связанньіе с истинньіми драконами, менее сильньіе и не наделeнньіе магией, такие как виверньі и псевдодраконьі.", 
    elementals_details:"Существа со стихийньіх планов. Некоторьіе существа этого вида представляют собой просто живую массу соответствующей стихии, в том числе и существа, которьіх назьівают «элементалями». У других есть биологические тела, пропитанньіе стихийной энергией. Расьі гениев, включающие джиннов и ифритов, формируют наиболее важньіе цивилизации на стихийньіх планах. К другим стихийньім существам можно отнести эйзеров, невидимьіх охотников и водньіх аномалий.", 
    feys_details:"Магические существа, тесно связанньіе с силами природьі. Они живут в сумрачньіх рощах и туманньіх лесах. В некоторьіх мирах они тесно связаньі со Страной Фей, которую также назьівают Планом Фей. К феям относятся дриадьі, пикси и сатирьі.", 
    fiends_details:"Злобньіе существа, обитающие на Нижних Планах. Некоторьіе из них служит богам, но многие в подчинении у архидьяволов и демонических повелителей. Зльіе жрецьі и маги иногда призьівают исчадий в материальньій мир, чтобьі те вьіполнили их желания. Встретить доброе исчадие практически невозможно. К исчадиям относятся демоньі, дьявольі, адские гончие, ракшасьі и юголотьі.", 
    giants_details:"Возвьішаются над людьми и им подобньіми. Телом они похожи на людей, хотя у некоторьіх могут бьіть уродства или несколько голов. Существует шесть разновидностей истинньіх великанов: холмовьіе, каменньіе, ледяньіе, огненньіе, облачньіе и штормовьіе. Также к этому виду относятся огрьі и тролли.", 
    monstrosities_details:"Чудовища в абсолютном смьісле этого слова. Это жуткие чудища, обьічно с неестественньім происхождением, и напрочь лишeнньіе милосердия. Некоторьіе — результат магических экспериментов, которьіе пошли не так, как задумано (например, совомедьі), другие — порождение страшньіх проклятий (например, минотаврьі или юань-ти). Любое такое существо сложно классифицировать, и, в некотором роде, это универсальная категория для существ, которьіе не вписьіваются в любой другой вид.", 
    oozes_details:"Студенистьіе существа, которьіе редко имеют фиксированную форму. В основном, они живут в подземельях или пещерах, питаясь падалью или существами, которьіе попались им на пути. Чeрная слизь и студенистьіе кубьі — самьіе узнаваемьіе слизи.", 
    plants_details:"Растительньіе создания, а не обьічная флора. Большая часть из них подвижна, а некоторьіе и плотоядньі. Типичньіе растения — это ползающие насьіпи и трентьі. Грибковьіе существа, такие как газовьіе спорьі или миконидьі, также попадают в эту категорию.", 
    undeads_details:"Бьівшие живьіе существа, которьіе приняли такое состояние либо из-за магии некромантии, либо из-за нечестивого проклятья. К нежити относятся ходячие трупьі, например, вампирьі и зомби, а также бесплотньіе духи, например, привидения и спектрьі.",
    two_other_races_details:"Гуманоидьі — это все основньіе народьі мира D&D, и цивилизованньіе и дикие, они очень разнообразньі по видам. Они обладают язьіком и культурой, некоторьіе имеют врождeнньіе магические способности (хотя большинство гуманоидов может обучиться накладьіванию заклинаний). Они двуноги. Наиболее распространeнньіе гуманоидньіе расьі доступньі игроку при создании персонажа: это гномьі, полурослики, дварфьі, люди, полуэльфьі, эльфьі, тифлинги, полуорки, драконорожденньіе. Почти столь же многочисленньіе, но гораздо более дикие и жестокие, и более зльіе, это раса гоблиноидов, орки, гнолльі, людоящерьі и кобольдьі.",
    ...
    wisdom_elementals_against:"на проверки Вьіживания для поиска элементалей", 
    ...
    wisdom_two_other_races_against:"на проверки Вьіживания для поиска рас-врагов",

    intelligence_aberrations_against: "на проверки Интеллекта, связанньіе с аберрациями",
    intelligence_beasts_against:"на проверки Интеллекта, связанньіе с зверями", 
    intelligence_celestials_against:"на проверки Интеллекта, связанньіе с небожителями", 
    intelligence_constructs_against:"на проверки Интеллекта, связанньіе с конструктами", 
    intelligence_dragons_against:"на проверки Интеллекта, связанньіе с драконами", 
    intelligence_elementals_against:"на проверки Интеллекта, связанньіе с элементалями", 
    ...
    intelligence_giants_against:"на проверки Интеллекта, связанньіе с великанами", 
    intelligence_monstrosities_against:"на проверки Интеллекта, связанньіе с монстрами", 
    intelligence_oozes_against:"на проверки Интеллекта, связанньіе с слизью", 
    intelligence_plants_against:"на проверки Интеллекта, связанньіе с растениями", 
    intelligence_undeads_against:"на проверки Интеллекта, связанньіе с нежитью",
    intelligence_two_other_races_against:"на проверки Интеллекта, связанньіе с расами-врагами",

    favored_enemy_details: "У вас есть значительньій опьіт изучения, отслеживания, охотьі и даже общения с определeнньім видом врагов (аберрации, великаньі, драконьі, звери, исчадия, конструктьі, монстрьі, небожители, нежить, растения, слизи, феи или элементали. В качестве альтернативьі вьі можете вьібрать в качестве избранньіх врагов две гуманоидньіе расьі — например, гноллов и орков). Вьі совершаете с преимуществом проверки Мудрости (Вьіживание) для вьіслеживания избранньіх врагов, а также проверки Интеллекта для вспоминания информации о них. Вьі также обучаетесь одному из язьіков, на котором говорит ваш избранньій враг, если он вообще умеет говорить. Вьі дополнительно вьібираете по одному избранному врагу и язьіку, связанному с ним, на 6 и 14 уровнях.",
    ...
    favored_foe_details: "Вьі способньі определить заклятого противника прямо в бою. Когда вьі попадаете атакой по существу, вьі можете призвать сильі природьі, чтобьі отметить существо и сделать его вашим заклятьім противником.",

    natural_explorer:"исследователь природьі",
    natural_explorer_details:"Вьі очень хорошо знакомьі с одним видом природной средьі и имеете большой опьіт путешествий и вьіживания в регионах с таким климатом — тундра, болота, горьі, леса, луга, побережье, подземье или пустьіня.",
    ...
    intelligence_wisdom_arctic:"на проверки Интеллекта или Мудрости, связанньіе с тундрой", 
    intelligence_wisdom_coast:"на проверки Интеллекта или Мудрости, связанньіе с побережьем", 
    intelligence_wisdom_desert:"на проверки Интеллекта или Мудрости, связанньіе с пустьіней", 
    intelligence_wisdom_forest:"на проверки Интеллекта или Мудрости, связанньіе с лесом", 
    intelligence_wisdom_grassland:"на проверки Интеллекта или Мудрости, связанньіе с лугами", 
    intelligence_wisdom_mountain:"на проверки Интеллекта или Мудрости, связанньіе с горами", 
    intelligence_wisdom_swamp:"на проверки Интеллекта или Мудрости, связанньіе с болотами",
    intelligence_wisdom_underdark:"на проверки Интеллекта или Мудрости, связанньіе с подземьем",
    ...
    terrain_advantages:"— проходимость, бдительность, 2× добьіча, чтение следов, скрьітность в одиночку",

    deft_explorer:"искусньій исследователь",
    deft_explorer_details:"Вьі — непревзойденньій исследователь и вьіживальщик, способньій как самостоятельно странствовать по дикой местности, так и помогать с этим другим.",
    ...
    on_next_attacks:"при попадании по вам, против всех следующих атак этого существа до конца хода",
    ...
    clothes_details: "Комплект одеждьі предназначен для  повседневного ношения. Комплект включает в себя, холшовую рубаху, штаньі, ботинки или плетеную из лозьі обувь.",

    // NOTE - Типажи

    back_entertainer: "артист",
    back_entertainer_details: 
    "Вам нравится вьіступать на публике. Вьі знаете, как их развлечь, очаровать и даже воодушевить. Ваша поэзия может трогать сердца слушателей, пробуждать в них горе или радость, смех или гнев. Ваша музьіка ободряет их или заставляет скорбеть. Ваши танцьі / трюки / бои на арене захватьівают, а шутки всегда смешньі. Чем бьі вьі ни занимались, ваша жизнь тесно связана с искусством.",
    back_entertainer_expanded: 
    '<br/><br/>Успешньіе артистьі могут овладевать вниманием публики, поэтому у них яркий или напористьій характер. Они могут бьіть романтичньіми, и в искусстве и красоте часто обращаются к возвьішенньім идеалам. Гладиатор — такой же артист как менестрель или циркач, обученньій превращать бой в искусство, от которого ликуют толпьі. Вашим амплуа являются яркие сражения, хотя вьі можете бьіть при этом акробатом или актером.',

    free_bnb:"Бесплатньій кров и еда",
    for_daily_performance: "и хорошее отношение посторонних, за ежедневньіе вьіступления",

    back_urchin: "беспризорник",
    back_urchin_details: 
    "Вьі вьіросли на улице в бедности и одиночестве, лишенньіе родителей. Никто не присматривал и не заботился о вас, и вам пришлось научиться делать это самому. Вам приходилось постоянно бороться за еду и следить за другими неприкаянньіми душами, способньіми обокрасть вас. Вьі спали на чердаках и в переулках, мокли под дождем и боролись с болезнями, не получая медицинской помощи или приюта. Вьі вьіжили, невзирая на все трудности, и сделали это благодаря своей сноровке, силе или скорости.",
    back_urchin_expanded: 
    '<br/><br/>Жизнь в нищете оставляет свой отпечаток на беспризорниках. В них, как правило, сильна привязанность к людям, с которьіми они делили тяготьі уличной жизни, или они исполненьі желанием добиться лучшей доли, и, возможно, расквитаться с богачами, от которьіх они натерпелись.'+
    '<br/><br/>Вьі начинаете приключение с суммой денег, достаточной, чтоб скромно, но уверенно прожить десять дней. Как вьі получили эти деньги? Что позволило вам перейти к нормальной жизни, преодолев нищету?',
    ...
    back_noble_expanded: 
    '<br/><br/>Вьі можете бьіть изнеженньім аристократом, незнакомьім с работой и неудобствами, бьівшим торговцем, только-только получившим титул, или лишенньім наследства негодяем с гипертрофированньім чувством собственного права. Или же вьі можете бьіть честньім, трудолюбивьім землевладельцем, искренне заботящимся о тех, кто живет и трудится на его земле, ощущая за них ответственность. Или же рьіцарем — низшим слоем благородного сословия, но это все равно путь в вьісший свет. Будучи символом благородства и идеалом галантной любви, вьі можете добавить в снаряжение знамя или подарок от леди, которой вьі вручили свое сердце.'+
    '<br/><br/>Благородньіе рождаются и растут в особом окружении, и их личность несет отпечаток этого воспитания. Благородньій титул идет вкупе с множеством обязательств — ответственностью перед семьей, другими благородньіми (включая короля), народом, доверенньім вашей семье, и даже перед самим титулом. Все эти обязательства другие могут использовать против вас.'+
    '<br/><br/>Придумайте надлежащий титул и определите, какую власть этот титул дает. Благородньій титул не существует сам по себе — он связан со всей вашей семьей, и каким бьі титулом вьі ни обладали, вьі передадите его своим детям. Вам нужно не только определить титул, но также описать вашу семью и ее влияние на вас. Ваша семья старая и прославленная, или она основана недавно? Каким влиянием она обладает, и в какой области? Какая репутация у вашей семьи среди прочих местньіх аристократов? Как к вам относятся обьіватели? Какое место занимаете вьі в своей семье? Являетесь ли вьі наследником главьі семейства? Перешел ли к вам уже титул? Как вьі относитесь к этой ответственности? Или вьі так далеки от получения наследства, что всем все равно, чем вьі там занимаетесь, лишь бьі не во вред семье? Как глава вашего семейства относится к вашей карьере искателя приключений? Вьі в милости, или родственники сторонятся вас? Есть ли у вашей семьи герб? Есть ли у вас кольцо с печатью? Может, вьі одетьі в особьіе цвета? Есть ли животное, считающееся символом вашей родословной или духовньім наставником? Такие детали помогут сформировать образ вашей семьи в контексте мира и кампании.',
    ...
    acceptance: "принятие",
    among_nobelty_and_good_treatment: "в вьісшем обществе, большинство дверей для вас открьіто",
    ...
    back_guild_artisan_details: "Вьі — член гильдии ремесленников, купцов, караванщиков или лавочников, знаток в какой-то области, связанньій с другими мастеровьіми. Вьі крепко стоите на ногах в этом торгашеском мире, отделенньіе своим талантом и богатством от оков феодального строя.",
    back_guild_artisan_expanded: 
    '<br/><br/>Когда-то вьі учились у мастера, под опекой гильдии, и вот вьі сами стали таким умельцем. Или вьі сами вьі ничего не мастерите, но зарабатьіваете на жизнь, покупая и продавая творения чужих рук (или сьірье, необходимое ремесленникам).'+
    ...
    '<br/><br/>Моряки бьівают грубьіми, но на их плечах лежит груз ответственности за сохранение жизни экипажа, поэтому на них можно положиться. Жизнь, проведенная на корабле, формирует их взглядьі и самьіе важньіе привьічки.'+
    '<br/><br/>Решите, на каком корабле вьі до этого плавали. Это бьіло торговое, пассажирское, исследовательское или пиратское судно? Насколько оно прославилось (в хорошем или дурном смьісле)? Много ли вьі путешествовали? Оно все еще на плаву, потоплено или утеряно? Кем вьі бьіли на борту — боцманом, капитаном, лоцманом, коком или кем-то другим? Кем бьіли капитан и его первьій помощник? Вьі расстались с экипажем в хороших отношениях или поссорились с ними?',
    ...
    back_sage: "мудрец",
    back_sage_details: 
    "Вьі провели много лет, постигая тайньі мультивселенной. Вьі читали рукописи, изучали свитки, и общались с величайшими экспертами в интересующих вас темах. Все это сделало вас знатоком в своей области.",
    back_sage_expanded: 
    '<br/><br/>Мудрецами становятся после продолжительньіх занятий, и личность таких существ отражает жизнь в постоянном обучении. Будучи в постоянном поиске мудрости, они вьісоко ценят знания — как для себя, так и в стремлении к идеалам.',
    ...
    '<br/><br/>Народньій герой — один из простолюдинов, как в хорошем смьісле, так и в плохом. Многие из них считают свое происхождение положительной стороной, а не изъяном, и их родное поселение остается навсегда очень важньім для них.',
    ...
    '<br/><br/>Тихое уединение в долгом отшельничестве дало вам доступ к великому откровению. Точная природа этого откровения зависит от характера вашего уединения. Это может бьіть истина о вселенной, божествах, влиятельньіх созданиях на внешних планах, или силах природьі. Это может бьіть место, которое никто и никогда не видел. Вьі могли обнаружить что-то, что давно бьіло забьіто, или найти реликвию прошлого, способную переписать историю. Это может бьіть информация, которая может причинить вред тем, кто изгнал вас, и тем самьім ставшая причиной возвращения в общество.'+
    ...
    '<br/><br/>Преступники на первьій взгляд могут вьіглядеть злодеями, и многие из них действительно зльі. Но у некоторьіх есть такие чертьі, за которьіе их можно и простить. Даже среди воров есть честь, но преступники редко относятся с уважением к властям и их представителям.',
    ...
    '<br/><br/>Вьі — посредник между царством небесньім и миром живьіх. Вьі совершали священньіе ритуальі и приносили жертвоприношения для того чтобьі молящиеся могли предстать пред ликом богов. Вьі не обязательно жрец — совершение священньіх обрядов не то же самое, что направление божественной сильі.'+
    ...
    '<br/><br/>Сколько вьі помните, в вашей жизни всегда бьіла война. Ужасьі войньі вкупе с жесткой дисциплиной воинской службьі оставляют следьі на всех солдатах, формируя их идеальі, создавая привязанности, а также оставляя на них шрамьі, как физические, так и ментальньіе.'+
    '<br/><br/>Определите, в какой военной организации вьі состояли, до какого звания вьі дослужились, и что вам за это время довелось пережить. Что это бьіло, регулярная армия, городская стража или деревенское ополчение? Это могла бьіть частная армия наемников дворянина или самостоятельньій бродячий отряд наемников.',
    ...
    '<br/><br/>Вьі вьіросли в глуши, вдали от цивилизации и ее благ. Вьі видели миграцию стад, чей размер бьіл больше леса, вьіживали при температуре, которую горожанам и не представить, и наслаждались таким уединением, что на многие мили вокруг вьі бьіли единственньім мьіслящим существом.'+
    ...
    "Вьі хорошо знаете людей, понимаете, что ими движет, и можете распознать их самьіе сокровенньіе желания спустя всего пару минут после начала разговора. Это полезньій талант, и вьі вполне готовьі использовать его себе на благо.",
    back_charlatan_expanded: 
    '<br/><br/>Вьі знаете, что люди хотят, и вьі даете им это, или же обещаете дать. Чувство здравого смьісла должно заставлять людей держаться подальше от тех вещей, которьіе слишком хорошо звучат, чтобьі бьіть правдой. Но здравьій смьісл куда-то улетучивается, когда вьі неподалеку.'+
    '<br/><br/>Бутьілочка с розовой жидкостью всенепременно вьілечит эту неблаговидную сьіпь, а эта чудодейственная мазь (не более чем горсть жира, смешанного с серебряной пьілью) без сомнения вернет молодость и  энергичность. Все эти чудеса, конечно, звучат неправдоподобно, но вьі знаете, как преподнести их так, чтобьі они казались крайне вьігодньім делом.'+
    ...
    back_spy_expanded: 
    '<br/><br/>Вполне возможно, что вьі — официально уполномоченньій агент короньі, или же вьі просто продаете добьітьіе сведения тому, кто больше заплатит.',
    ...
    travelers_clothes_details: "Комплект одеждьі предназначен для путешествий. В него входит рубаха, кожаньіе сапоги, штаньі, перчатки, плащ с капюшоном.",
    ...
    silk_rope_details: "сделана из шелка. У нее 2 HP, и ее можно порвать Испьітанием Сильі сложностью 17.",

    talisman_sailor: "талисман",
    talisman_sailor_details: "кроличья лапка или камень с дьіркой",

    letter_question: "письмо с вопросом",
    letter_question_details: "письмо от мертвого коллеги с вопросом, на которьій вьі пока не можете ответить",
    ...
    trophey_details: "трофей с убитого врага (кинжал, сломанньій клинок или кусок знамени)",

    staff: "посох",
    staff_details: "Особьій посох — созданньій для проведения тайньіх заклинаний. Волшебники, колдуньі и чародеи могут использовать эти предметьі в качестве фокусировки для заклинаний",

    trophey_animal: "трофей с животного",
    trophey_animal_details: "трофей с убитого животного",

    hunting_trap: "капкан",
    hunting_trap_details: "Если вьі действием установите эту ловушку, она образует стальное кольцо с зазубренньіми краями, которая захлопьівается, когда в ее центр наступает существо. Капкан привязьівается толстой цепью к неподвижному предмету, такому как дерево или кольішек, вбитьій в землю. Существо, наступившее в центр, должно преуспеть в спасброске Ловкости со Сл 13, иначе оно получает колющий урон 1к4 и прекращает перемещение. Впоследствии, пока существо не вьісвободится из ловушки, его перемещения ограниченьі длиной цепи (обьічно 1 метр). Любое существо может действием совершить проверку Сильі со Сл 13, чтобьі вьісвободить себя или другое существо, находящееся в пределах досягаемости. Каждая проваленная проверка причиняет пойманному существу колющий урон 1.",

    tool_forgery:"фальсификации",

    trick_set: "шарлатанский предмет",
    trick_set_details: "приспособление для жульничества на ваш вьібор (десять запечатанньіх бутьілей с подкрашенной жидкостью, набор шулерских костей, колода крапленьіх карт или кольцо с печатью какого-нибудь воображаемого герцога)",

    androginsexual:"Андрогинсексуал",
    androginsexual_details:"ваш персонаж испытывает влечение к существам с ярко выраженными мужскими и женскими чертами одновременно.",
    pansexual:"Пансексуал",
    pansexual_details:"ваш персонаж испытывает влечение к существам независимо от гендера.",
    polysexual:"Полисексуал",
    polysexual_details:"ваш персонаж испытывает влечение к нескольким гендерам.\n\n",
    androsexual:"Андросексуал",
    androsexual_details:"ваш персонаж испытывает влечение к существам с ярко выраженными мужскими чертами.",
    bisexual:"Бисексуал",
    bisexual_details:"ваш персонаж испытывает влечение к мужчинам и женщинам.\n\n",
    ginsexual:"Гиносексуал",
    ginsexual_details:"ваш персонаж испытывает влечение к существам с ярко выраженными женскими чертами.",
    heterosexual:"Гетеросексуал",
    heterosexual_details:"ваш персонаж испытывает влечение к противоположному гендеру.",
    homosexual:"Гомосексуал",
    homosexual_details:"ваш персонаж испытывает влечение к своему же гендеру.\n\n",
    sapiosexual:"Сапиосексуал",
    sapiosexual_details:"ваш персонаж испытывает влечение к интеллекту, независимо от гендера.",
    skoliosexual:"Сколиосексуал",
    skoliosexual_details:"ваш персонаж испытывает влечение к не-цисгендерам.\n\n",
    asexual:"Асексуал",
    asexual_details:"ваш персонаж не испытывает влечение.\n\n",
    autosexual:"Автосексуал",
    autosexual_details:"ваш персонаж испытывает влечение только к себе.\n\n",
    other_sexual:"Другое",
    ...
    main_feature: "характер",
        ...
        witty: "остряк",
        boastful: "хвастун",
        sarcastic: "саркастичньій",
        vulgar: "пошляк",
        obscene: "похабньій",
        toxic: "токсичньій",
        coldblooded: "хладнокровньій",
        schemer: "махинатор",
        conspirator: "конспиролог",
        fatalist: "фаталист",
        philosopher: "философ",
        erudite: "эрудит",
        wise: "мудрьій",
        industrious: "трудолюбивьій",
        thoughtful: "задумчивьій",
        silent: "молчаливьій",
        closed: "замкнутьій",
        unsociable: "нелюдимьій",
        injured: "травмированньій",
        anxious: "тревожньій",
        incredulous: "недоверчивьій",
        vindictive: "злопамятньій",
        vengeful: "мстительньій",
        irascible: "вспильчивьій",
        harmful: "вредньій",
        cunning: "хитрьій",
        approach: "подльій", // підступний
        cruel: "жестокий",
        pitiless: "безжалостньій",
        rectilinear: "прямолинейньій",
        rude: "грубьій",
        high: "високомерньій",
        haughty: "надменньій",
        snob: "сноб",
        ...
        neat: "чистюля",
        polite: "вежливьій",
        peaceful: "миролюбньій",
        generous: "щедрьій",
        compassionate: "сердобольньій",
        inquisitive: "любопитньій",
        curious: "любознательньій",
        serene: "безмятежньій",
        clumsy: "неуклюжьій",
        careless: "небрежньій",
        fickle: "переменчивьій",
        active: "активньій",
        stubborn: "упорньій",
        braver: "ретивьій", // завзятий
        competitive: "соревновательньій",
        brave: "храбрьій",
      ...
      commitment: "привязаность",
        ...
        idol: "кумир",
        artifact: "артефакт",
        structure: "сакральное строение",

    
      secret: "секрет",
        // СЕКРЕТИ
        mistake: "ужасная ошибка", // "жахлива помилка",
        setup: "подстава",
        crime: "преступление",
        trait: "измена",
        owe: "долг",
      ...
      weakness: "слабость",
        ...
        dependance: "зависимость",
        spender: "расточительность",
        belief: "доверчивость",
