...
//Заклинания - активные умения с уроном
    ...
    fiends:"исчадия", 
    giants:"великаны", 
    monstrosities:"монстры", 
    oozes:"слизи", 
    plants:"растения", 
    undeads:"нежить",
    two_other_races:"две другие гуманоидные расы",

    aberrations_details: "Абсолютно чужеродные существа. Многие из них имеют врождённые магические способности, однако обусловлены они их чужеродным разумом, а не мистическими силами мира.",
    beasts_details:"Негуманоидные существа, являющиеся фауной мира фэнтези. Некоторые из них имеют магические силы, но большая часть неразумна, не владеет языками и не имеет никакого общественного строя. Звери включают в себя всё многообразие животных, динозавров и гигантских версий животных.", 
    celestials_details:"Существа из Верхних Планов. Многие из них являются слугами божеств, и выполняют роль посланников и агентов в мире смертных и других планах. Небожители добры от природы, поэтому небожитель, сбившийся с пути добра, это ужасная редкость. К небожителям относятся ангелы, коатли и пегасы.", 
    constructs_details:"Создаются, а не рождаются. Некоторые запрограммированы создателем следовать простому набору инструкций, другие же имеют зачатки разума и способны к самостоятельному мышлению. Големы — это классические конструкты. Многие существа родом из внешнего плана Механус, такие как модроны, являются конструктами, созданными из материи этого плана волей могущественных существ.", 
    dragons_details:"Большие рептилиеподобные существа древнего происхождения и огромной силы. Истинные драконы, в том числе и добрые металлические драконы, и злые цветные драконы, очень умны и обладают врождённой магией. Также к этой категории относятся существа, отдалённо связанные с истинными драконами, менее сильные и не наделённые магией, такие как виверны и псевдодраконы.", 
    elementals_details:"Существа со стихийных планов. Некоторые существа этого вида представляют собой просто живую массу соответствующей стихии, в том числе и существа, которых называют «элементалями». У других есть биологические тела, пропитанные стихийной энергией. Расы гениев, включающие джиннов и ифритов, формируют наиболее важные цивилизации на стихийных планах. К другим стихийным существам можно отнести эйзеров, невидимых охотников и водных аномалий.", 
    feys_details:"Магические существа, тесно связанные с силами природы. Они живут в сумрачных рощах и туманных лесах. В некоторых мирах они тесно связаны со Страной Фей, которую также называют Планом Фей. К феям относятся дриады, пикси и сатиры.", 
    fiends_details:"Злобные существа, обитающие на Нижних Планах. Некоторые из них служит богам, но многие в подчинении у архидьяволов и демонических повелителей. Злые жрецы и маги иногда призывают исчадий в материальный мир, чтобы те выполнили их желания. Встретить доброе исчадие практически невозможно. К исчадиям относятся демоны, дьяволы, адские гончие, ракшасы и юголоты.", 
    giants_details:"Возвышаются над людьми и им подобными. Телом они похожи на людей, хотя у некоторых могут быть уродства или несколько голов. Существует шесть разновидностей истинных великанов: холмовые, каменные, ледяные, огненные, облачные и штормовые. Также к этому виду относятся огры и тролли.", 
    monstrosities_details:"Чудовища в абсолютном смысле этого слова. Это жуткие чудища, обычно с неестественным происхождением, и напрочь лишённые милосердия. Некоторые — результат магических экспериментов, которые пошли не так, как задумано (например, совомеды), другие — порождение страшных проклятий (например, минотавры или юань-ти). Любое такое существо сложно классифицировать, и, в некотором роде, это универсальная категория для существ, которые не вписываются в любой другой вид.", 
    oozes_details:"Студенистые существа, которые редко имеют фиксированную форму. В основном, они живут в подземельях или пещерах, питаясь падалью или существами, которые попались им на пути. Чёрная слизь и студенистые кубы — самые узнаваемые слизи.", 
    plants_details:"Растительные создания, а не обычная флора. Большая часть из них подвижна, а некоторые и плотоядны. Типичные растения — это ползающие насыпи и тренты. Грибковые существа, такие как газовые споры или микониды, также попадают в эту категорию.", 
    undeads_details:"Бывшие живые существа, которые приняли такое состояние либо из-за магии некромантии, либо из-за нечестивого проклятья. К нежити относятся ходячие трупы, например, вампиры и зомби, а также бесплотные духи, например, привидения и спектры.",
    two_other_races_details:"Гуманоиды — это все основные народы мира D&D, и цивилизованные и дикие, они очень разнообразны по видам. Они обладают языком и культурой, некоторые имеют врождённые магические способности (хотя большинство гуманоидов может обучиться накладыванию заклинаний). Они двуноги. Наиболее распространённые гуманоидные расы доступны игроку при создании персонажа: это гномы, полурослики, дварфы, люди, полуэльфы, эльфы, тифлинги, полуорки, драконорожденные. Почти столь же многочисленные, но гораздо более дикие и жестокие, и более злые, это раса гоблиноидов, орки, гноллы, людоящеры и кобольды.",

    wisdom_aberrations_against: "на проверки Выживания для поиска аберраций",
    wisdom_beasts_against:"на проверки Выживания для поиска зверей", 
    wisdom_celestials_against:"на проверки Выживания для поиска небожителей", 
    wisdom_constructs_against:"на проверки Выживания для поиска конструктов", 
    wisdom_dragons_against:"на проверки Выживания для поиска драконов", 
    wisdom_elementals_against:"на проверки Выживания для поиска элементалей", 
    wisdom_feys_against:"на проверки Выживания для поиска фей", 
    wisdom_fiends_against:"на проверки Выживания для поиска исчадий", 
    wisdom_giants_against:"на проверки Выживания для поиска великанов", 
    wisdom_monstrosities_against:"на проверки Выживания для поиска монстров", 
    wisdom_oozes_against:"на проверки Выживания для поиска слизи", 
    wisdom_plants_against:"на проверки Выживания для поиска растений", 
    wisdom_undeads_against:"на проверки Выживания для поиска нежити",
    wisdom_two_other_races_against:"на проверки Выживания для поиска рас-врагов",

    intelligence_aberrations_against: "на проверки Интеллекта, связанные с аберрациями",
    intelligence_beasts_against:"на проверки Интеллекта, связанные с зверями", 
    intelligence_celestials_against:"на проверки Интеллекта, связанные с небожителями", 
    intelligence_constructs_against:"на проверки Интеллекта, связанные с конструктами", 
    intelligence_dragons_against:"на проверки Интеллекта, связанные с драконами", 
    intelligence_elementals_against:"на проверки Интеллекта, связанные с элементалями", 
    intelligence_feys_against:"на проверки Интеллекта, связанные с феями", 
    intelligence_fiends_against:"на проверки Интеллекта, связанные с исчадиями", 
    intelligence_giants_against:"на проверки Интеллекта, связанные с великанами", 
    intelligence_monstrosities_against:"на проверки Интеллекта, связанные с монстрами", 
    intelligence_oozes_against:"на проверки Интеллекта, связанные с слизью", 
    intelligence_plants_against:"на проверки Интеллекта, связанные с растениями", 
    intelligence_undeads_against:"на проверки Интеллекта, связанные с нежитью",
    intelligence_two_other_races_against:"на проверки Интеллекта, связанные с расами-врагами",

    favored_enemy_details: "У вас есть значительный опыт изучения, отслеживания, охоты и даже общения с определённым видом врагов (аберрации, великаны, драконы, звери, исчадия, конструкты, монстры, небожители, нежить, растения, слизи, феи или элементали. В качестве альтернативы вы можете выбрать в качестве избранных врагов две гуманоидные расы — например, гноллов и орков). Вы совершаете с преимуществом проверки Мудрости (Выживание) для выслеживания избранных врагов, а также проверки Интеллекта для вспоминания информации о них. Вы также обучаетесь одному из языков, на котором говорит ваш избранный враг, если он вообще умеет говорить. Вы дополнительно выбираете по одному избранному врагу и языку, связанному с ним, на 6 и 14 уровнях.",
