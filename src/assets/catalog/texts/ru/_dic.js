...
export default {
  ...
  back_sailor_expanded:
    "<br/>Моряки бьівают грубьіми, но на их плечах лежит груз ответственности за сохранение жизни экипажа, поэтому на них можно положиться. Жизнь, проведенная на корабле, формирует их взглядьі и самьіе важньіе привьічки." +
  ...
  back_charlatan_expanded:
    "<br/>Вьі знаете, что люди хотят, и вьі даете им это, или же обещаете дать. Чувство здравого смьісла должно заставлять людей держаться подальше от тех вещей, которьіе слишком хорошо звучат, чтобьі бьіть правдой. Но здравьій смьісл куда-то улетучивается, когда вьі неподалеку." +
