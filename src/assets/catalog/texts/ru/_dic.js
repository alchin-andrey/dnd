...
export default {
  ...
  authors:
    ...
    phb_disclaimer:
      'Другие варианты недоступны для использования из-за ограничений системьі Open Gaming Licence от владельцев Dungeons & Dragons — Wizards of the Coast LLC ...',
  ...
  feat_custom_stalker_details:"Вы - эксперт в выслеживании добычи. Во время охоты вы чувствуете себя более уверенно, чем дома, и ваша добыча редко ускользает от вас.<br/><br/>" + races.rare,
