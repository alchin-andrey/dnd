...
export const langs = {
  ...
  dwarf_details: "Детек. Состоит из твердых согласных и гортанных звуков, и этот акцент будет присутствовать в любом языке, на котором дварф будет говорить. Буквами являются руны. В литературе собрана обширная история королевств дварфов и их войн на протяжении тысячелетий.",

  tiefling: "инфернальный",

  tiefling_details: "Язык дьяволов, которым пользуются тифлинги. Диалект божественного.",

  elf: "эльфийский",

  elf_details: "Эспуар. Текучий, с утонченными интонациями и сложной грамматикой. Эльфийская литература богата и разнообразна, а стихи и песни известны среди представителей других рас. Многие барды учат эльфийский язык, чтоб добавить песни в свой репертуар. Сами эльфы иногда называют его Истинная Речь.",
  ...
  dragon_details: "Драконик. Считается одним из старейших и часто используется во время изучения магии. Этот язык звучит грубо для большинства других существ, и содержит много твердых согласных и шипящих звуков.",
  ...
  "\n\nТакже в него входит набор секретных знаков и символов, используемый для передачи коротких и простых сообщений. Например, является ли область опасной или территорией гильдии воров, находится ли поблизости добыча, простодушны ли люди в округе, и предоставляют ли здесь безопасное убежище для воров в бегах.",

  druid: "друидский",
  druid_details: "Друэдан. Тайный язык друидов. На нем можно говорить и оставлять тайные послания. Те, кто знают этот язык, автоматически замечают эти послания. Другие замечают присутствие послания при успешной проверке на Внимательности ( сложность 15 ), но без помощи магии не могут расшифровать его. Он секретный, и им владеют лишь друиды, обучение не друидов запрещено под страхом смерти.",
  ...
  deep: "глубинный",
  deep_details: "Чужеродный язык общения Дальнего Предела, используемый существами, затронутых энергией этого места вне мира и планов. Глубинная речь использует письмо Релланик, из-за того что дроу были первыми, кто попытался её записывать, потому что они делят Подземье с этими искажёнными существами.",

  primordial: "первичный",
  primordial_details: "Первородниый. Гортанный язык, заполненный резкими слогами и твердыми согласными. Включает диалекты Акван, Ауран, Игнан, и Терран, по одному на каждый из четырех стихийных планов. Существа, говорящие на разных диалектах одного языка могут общаться между собой.",

  sky: "небесный",
  sky_details: "Язык ангелов и божеств. Диалект первичного языка.",

  demonic: "демонический",
  demonic_details: "Язык Бездны. Форма Первичного, искаженная и искривленная злом в сердце Бездны. Включает слова силы, чьи слоги содержат первородное зло. Персонажи могут изучить основы общения на языке Бездны, но не смогут освоить эти могущественные звуки. Тексты, содержащие такие слова могут обладать мощными эффектами — и тома или свитки с ними могут быть артефактами сами по себе.",
  ...
  teramian_details: "Язык народа Терами: " + races.terami_human,
