...
export const chill_touch_details = 'Атака лучом холода. <span class="buff">Замедляет</span> существо на 10 футов.';

export const chill_touch_expanded = 'Холодный сине-белый луч устремляется к существу, находящемуся в пределах дистанции. Совершите по цели дальнобойную атаку заклинанием. При попадании цель получает урон холодом 1к8, а скорость до начала вашего следующего хода уменьшается на 10 футов.\n\n' +
...
export const mending_details = 'Исправление одного повреждения размером до 1 фута на предмете.';
