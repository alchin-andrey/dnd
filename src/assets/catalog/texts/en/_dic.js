...
export default {
  ...
  'На відміну від сюжетних компʼютерних ігор, у розмовній рольовій грі Dungeons & Dragons <span class="buff">гравці можуть робити дійсно ЩО&nbsp;ЗАВГОДНО</span> і досягати цілей, рятуватися від небезпеки, та&nbsp;напряму впливати на світ гри дійсно неочікуваним чином. Як&nbsp;життя, але з магією.' +
  ...
  '<br/><br/>Module — Середня історія, зазвичай на 3-5 ігор. Наприклад <a target="_blank" href="https://youtu.be/7CjvWO05rA0?t=507">Подвійна&nbsp;Гра, від&nbsp;Dice&Bones</a>.'+
  
  '<br/><br/>Campaign — Масштабна історія, яка може тривати кілька місяців або навіть років. Ось як це робить команда <a target="_blank" href="https://youtu.be/P8pLvV3FjPc?t=756">Critical&nbsp;Role</a>&nbsp;(EN).'+
  
  '<br/><br/>D&D здатна сподобатися кожному. Це доводить її всесвітня популярність протягом вже 50+ років, не зважаючи на складність початку (до появи нашого сайту). Тому вдалий Ваншот легко може перетворитися на Модуль, або навіть на Кампейн і стати вашим другим, ще більш насиченим, життям.',

  lobby_what_is_it_details_1_1: 
  'На відміну від сюжетних компʼютерних ігор, у розмовній рольовій грі Dungeons & Dragons <span class="buff">гравці можуть робити дійсно</span> ',

  lobby_what_is_it_details_1_2: 
  '<span class="buff">ЩО&nbsp;ЗАВГОДНО</span> ',

  lobby_what_is_it_details_1_3: 
  'і досягати цілей, рятуватися від небезпеки, та&nbsp;напряму впливати на світ гри дійсно неочікуваним чином. Як&nbsp;життя, але з магією.' +
