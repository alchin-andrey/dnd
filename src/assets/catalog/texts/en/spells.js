...
'• Потужні породження, небожителі, невмерлі, феї та елементали<br/>'+
...
'Ви можете відкрити свою свідомість для виявлення таких сил. Ви до кінця свого наступного ходу знаєте місцезнаходження всіх породжень, небожителів та невмерлих в межах 60 футів, що не мають повного укриття. Ви знаєте тип (породження, небожитель, невмерлий) будь-якої істоти, чию присутність ви відчуваєте, але не можете визначити, хто це конкретно.<br/><br/>' +  
...
export const protection_from_evil_and_good_details = 'Аберації, породження, небожителі, невмерлі, феї чи елементали атакують союзника з перешкодою, і не можуть Перелякати, Зачарувати чи зробити Одержимим.';

export const protection_from_evil_and_good_expanded = 'Поки закляття активне, одна згодна істота, яку ви торкнулися, захищена від певного виду істот: аберації, породження, небожителі, невмерлі, феї чи елементали.<br/><br/>' + 
...
export const detect_evil_and_good_details = 'Знайти аберації, породження, небожителів, невмерлих, фей, елементалей або освячені/нечисті предмети.';

export const detect_evil_and_good_expanded = 'Поки закляття активне, ви знаєте, чи є в межах 30 футів від вас аберації, породження, небожителі, невмерлі, феї або елементали, а також їхнє розташування. Крім того, ви знаєте, чи є в межах 30 футів від вас місце або предмет, який був магічно освячений або опоганений.<br/><br/>' + 
...
export const divine_channel_devotion_2_details = 'Вигнати породження та невмерлих в межах дистанції, які бачать чи чують вас і провалили Випробування:<br/>' +
...
'Ви Основною дією показуєте свій священний символ і вимовляєте слова молитви, що засуджує породження і невмерлих, використовуючи Божественний канал. Всі породження та невмерлі, які можуть бачити або чути вас, що знаходяться в межах 30 футів від вас, повинні пройти Випробування Мудрості. Якщо вони провалюють Випробування, то виганяються на 1 хвилину або доти, доки не отримають пошкодження. Вигнані істоти повинні весь свій хід намагатися втекти від вас так далеко, як можуть, і не можуть добровільно переміститися в простір, що знаходиться в межах 30 футів від вас. Також вони не можуть здійснювати Реакції. З усіх дій вони можуть робити тільки Ривок і спроби уникнути ефектів, що не дає їм переміщатися. Якщо ж рухатися нікуди, істоти можуть використовувати дію Ухилення.<br/><br/>' + divine_channel_expanded;
...
export const divine_channel_vengence_1_details = '😱 Перелякати істоту, що провалила Випробування. Породження або невмерлий отримує <span class="buff">перешкоду</span> на Випробування. Пошкодження по істоті знімає ефект.';

export const divine_channel_vengence_1_expanded = 
'Ви Основною дією демонструєте свій священний символ і вимовляєте молитву-вирок використовуючи Божественний канал. Виберіть одну істоту в межах 60 футів, яку можете бачити. Ця істота повинна пройти Випробування Мудрості, якщо не має імунітету до Переляку. Породження і невмерлі роблять це Випробування з перешкодою. Якщо Випробування провалене, істота стає Переляканою на 1 хвилину, або поки не отримає пошкодження. Поки істота Перелякана, її швидкість дорівнює 0, і вона не отримує жодних бонусів до швидкості. Якщо спаскидок був успішний, швидкість істоти на 1 хвилину, або поки вона не отримує пошкодження, зменшується вдвічі.<br/><br/>' + divine_channel_expanded;
...
export const primeval_awareness_details = 'Визначити без деталей, чи є в межах дальності аберації, дракони, породження, небожителі, невмерлі, феї та елементалі.';

export const primeval_awareness_expanded = 'Ви можете Основною дією витратити один слот мани, щоб зосередитися на пізнанні простору навколо себе. Протягом 1 хвилини за кожний рівень використаного слоту ви можете відчути присутність наступних видів істот у межах 1 милі (або в межах 6 миль, якщо ви перебуваєте в обраній місцевості): аберації, дракони, породження, небожителі, невмерлі, феї та елементали. Це вміння не розкриває розташування та кількість істот.';
...
export const protection_from_evil_and_good_paladin_details = 'Аберації, породження, небожителі, невмерлі, феї чи елементали атакують вас з перешкодою, і не можуть Перелякати, Зачарувати чи зробити Одержимим.';
...
'Поки закляття активне, ви захищені від певного виду істот: аберації, породження, небожителі, невмерлі, феї чи елементалі.<br/><br/>' + 
...
'Крім того, протягом цього часу ви робите з перевагою Випробування від заклять, створених породженнями і невмерлими.<br/><br/>' + 
