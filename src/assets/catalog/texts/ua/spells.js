...
'Ви та все що ви носите та несете, стає невидимим.';
...
export const thunderous_smite_expanded = 'Вперше, коли ви потрапляєте атакою ближньою зброєю, поки закляття активне, ваша зброя видає громовий гуркіт, чутний з відстані 300 футів, і атака завдає мети додаткове пошкодження Звуком 2d6.<br/><br/>' +
...
'Ви можете один раз створити закляття Пристріт, використовуючи слот мани чаклуна. Ви не можете зробити це повторно, поки не закінчите тривалий відпочинок.';
...
'Поки закляття активно, ціль робить з перевагою Виробування від Отруєного стану і отримує стійкість до пошкодження Отрутою.';
...
export const alter_self_druid = 'Самозміна друїда';
export const alter_self_warlock = 'Самозміна чаклуна';
...
export const darkvision_expanded = 'Ви торкаєтеся згодної істоти і даруєте їй можливість бачити у темряві. Поки закляття активно, ця істота має темний зір у межах 60 футів.<br/><br/>' +  
...
'Коли ви здійснюєте дію Ривок, ви можете Бонусною дією зробити одну ближню атаку зброєю. Якщо ви перед здійсненням цієї Бонусної дії перемістилися щонайменше на 10 футів по прямій лінії, ви або отримуєте бонус +5 до кидка пошкодження цієї атаки (якщо ви вирішили зробити рукопашну атаку і влучили).';
...
'Починаючи з 6 рівня, коли видима вами істота, що знаходиться в межах 30 футів від вас, отримує шкоду, ви можете реакцією поглинути цю шкоду вашим Магічним Захистом. Якщо шкода опускає хіти захисту до 0, то істота, що захищається, отримує всю шкоду, що залишилася.<br/><br/>'+
...
'Ви можете збільшити силу своїх найпростіших заклинань. Створюючи закляття чарівника, що завдає пошкодження, з 1 по 5 коло, ви можете завдати максимальне пошкодження.<br/><br/>'+
'Без шкоди для себе Ви можете використати це вміння один раз. Якщо Ви повторно використовуєте це вміння до закінчення довгого відпочинку, то отримуєте шкоду некротичною енергією 2к12 за кожне коло закляття відразу після створення. Кожен наступний раз, при використанні даного вміння до закінчення довгого відпочинку, шкода некротичною енергією збільшується на 1к12. Ця шкода ігнорує опір та імунітет.';
...
'Ви можете гучно покарати атакуючих. Якщо істота в межах 5 футів від вас, яку ви можете бачити, успішно потрапляє атакою по вас, ви можете Реакцією змусити істоту пройти Випробування Спритності. Істота отримує пошкодження Струмом або Звуком (на ваш вибір) 2d8, якщо провалить Випробування, і половину цього пошкодження якщо досягне успіху.<br/><br/>' + 
...
'Ви можете використовувати Божественний канал, щоб завдати удару з надприродною точністю. Коли ви здійснюєте кидок атаки, ви можете використовувати Божественний канал, щоб отримати бонус +10 до кидка. Ви можете вирішити, чи застосовувати це вміння, після того, як побачите результат кидка, але до того як Майстер скаже, потрапила атака або промахнулася.';
...
'Якщо істота в межах 30 футів від вас робить кидок атаки, ви можете Реакцією надати цій істоті бонус +10 до кидка, використовуючи Божественний канал. Ви можете вирішити, чи застосовувати це вміння, після того, як побачите результат кидка, але до того як Майстер скаже, потрапила атака або промахнулася.';
...
'Випустити яскраве світло в межах дальності, що дає <span class="debuff">перешкоду</span> на Випробування проти заклинань з пошкодженням 🔥 Вогнем або ✨ Світлом.';
...
'Ви випромінюєте яскраве світло в радіусі 60 футів і тьмяне світло в радіусі ще 30 футів. Ваші супротивники, що знаходяться на яскравому світлі, роблять з перешкодою спаски від будь-яких заклинань, що завдають пошкодження Вогнем або Світлом.';
...
export const eldritch_blast_slow_expanded = 'Один раз у кожному з ваших ходів, коли ви потрапляєте по істоті Містичним зарядом, ви можете до кінця наступного ходу зменшити його швидкість на 10 футів.';
...
export const eldritch_blast_push_expanded = 'Якщо ви потрапляєте по істоті Містичним зарядом, ви можете штовхнути його на 10 футів від себе прямою лінією.';
...
export const dark_delirium_expanded = 'Ви можете занурювати істот у ілюзорний простір. Виберіть видиму істоту в межах 60 футів від себе. Воно має здійснити спаски Мудрості зі Сл ваших заклинань чаклуна. У разі провалу воно Зачароване або Налякане вами (на ваш вибір) протягом 1 хвилини, або поки ви не втратите концентрацію (якби концентрувалися на заклинанні). Поки ілюзія триває, істота вважає, що вона загубилася у туманному просторі, образ якого ви вибираєте. Істота може бачити і чути лише себе, вас та ілюзію.<br/><br/>'+
...
'• Мета має пройти Випробування Сили. У разі провалу ви можете штовхнути її від себе на відстань до 15 футів.<br/><br/>'+
...
export const sanctuary_monk = 'Умиротворення';
...
export const pass_without_trace_monk = 'Безслідне пересування монаха';
...
export const darkvision_monk = 'Темний зір монаха';

export const darkvision_monk_expanded = 'Ви торкаєтеся згодної істоти і даруєте їй можливість бачити у темряві. Поки закляття активно, ця істота має темний зір у межах 60 футів.';

export const silence_monk = 'Тиша монаха';

export const darkness_monk = "Темрява";
...
export const gust_of_wind_monk = 'Порив вітру';
...
export const hold_person_monk = 'Утримання особи';
...
export const primal_awareness_expanded = "<br/><br/>Ви можете один раз застосувати це закляття без використання мани і додаткового часу на каст. Як тільки ви використовуєте закляття таким чином, ви не зможете зробити це повторно до закінчення тривалого відпочинку."

export const speak_with_animals_ranger = 'Розмова з тваринами';
...
export const beast_sense_ranger = 'Чуття звіра';
...
export const commune_with_nature_ranger = 'Спілкування з природою';
...
export const colossus_slayer_expanded = 'Ваша завзятість може повалити самих потужних ворогів. Якщо ви потрапляєте по істоті атакою зброєю, ця істота отримує додаткове пошкодження 1d8, якщо її здоровʼя вже нижче максимуму. Ви можете заподіяти цю додаткове пошкодження тільки один раз у хід.';
...
export const holy_nimbus_details = 'Випромінювати сонячне світло і завдавати ним пошкодження. Отримати <span class="buff">перевагу</span> на Випробування від заклинань породжень та немертвих.';
...
'Крім того, протягом цього часу ви робите з перевагою Випробування від заклинань, створених породженнями і немертвими.<br/><br/>' + 
...
export const control_undead = 'Керування нежиттю';

export const control_undead_details = 'Підкорити одного немертвого в межах дальності.';

export const control_undead_expanded = 'Ви можете магією підкорити собі немертвого, навіть якщо він створений іншим чарівником. Ви можете вибрати одного немертвого в межах 60 футів від себе, якого можете бачити. Ця істота має пройти Випробування Харизми проти складності ваших заклять. Якщо воно успішне, ви не можете більше використовувати це вміння на цю ціль. Якщо воно провалене, ціль стає дружньою до вас і підкоряється вашим командам, доки ви не використовуєте це вміння знову. Розумна нежить керується подібним способом набагато важче.<br/><br/>'+
...
export const instinct_charm_expanded = 'Коли істота, яку ви бачите і яка знаходиться в межах 30 футів від вас, здійснює кидок атаки по вам, ви можете Реакцією перенаправити атаку, за умови, що є інша істота, яка знаходиться в межах цієї атаки. Атакуючий повинен пройти Випробування Мудрості проти складності ваших заклять. При провалі атакуючий повинен вибрати як ціль найближчу істоту (крім вас і себе). Якщо є кілька потенційних цілей, атакуючий сам вибирає ціль серед них. У разі успіху ви не можете використати це вміння проти атакуючого, доки не завершите тривалий відпочинок. Ви повинні вирішити, чи використовуватимете це вміння, перш ніж буде відомо, потрапила атака або промахнулася. Істоти, яких не можна зачарувати, мають імунітет до цього ефекту.';
...
'* Істоти з істинним зором можуть у певному радіусі бачити у звичайній і магічній темряві, бачити невидимі істоти та предмети, автоматично виявляти зорові ілюзії і процвітати від них, і бачити справжній вигляд перевертків і істот, перетворених магією. Крім того, зір таких істот тягнеться на Ефірний План.';
...
export const fireball_monk = 'Вогняна куля монаха';
...
export const cone_of_cold_monk = 'Конус холоду монаха';
...
export const wall_of_stone_monk = 'Камʼяна стіна монаха';
...
export const stoneskin_expanded = 'Це закляття робить плоть згодної істоти, до якої ви доторкнулися, твердою як камінь. Поки закляття активно, ціль отримує стійкість до немагічного Дробильного, Колотого і Рубаного пошкодження.';
...
export const stoneskin_monk_expanded = 'Це закляття робить вашу плоть плоть твердою як камінь. Поки закляття активно, ви отримуєье стійкість до немагічного Дробильного, Колотого і Рубаного пошкодження.';

export const wall_of_fire = 'Вогняна стіна';
export const wall_of_fire_monk = 'Вогняна стіна монаха';
...
'Стіна непрозора і існує, доки активно закляття. Коли стіна зʼявляється, всі істоти в її області повинні пройти Випробування Спритливості. При провалі вони отримують пошкодження Вогнем 5d8 або половину цього пошкодження при успіху.<br/><br/>'+
...
'Якщо ви накладаєте це закляття, використовуючи слот мани 5 рівня або вище, шкода збільшується на 1d8 за кожен рівень слот мани вище за четвертий.<br/><br/>'+
...
export const beacon_of_hope_expanded = 'Це закляття дарує надію та живучість. Оберіть будь-яку кількість істот у межах дистанції. Поки закляття активно, усі цілі здійснюють Випробування Мудрості та кидки від смерті з перевагою, а також відновлює від будь-якого лікування максимально можливу кількість здововʼя.';
...
'Якщо ви накладаєте це закляття, використовуючи слот 4 або вище рівня, ви автоматично закінчуєте ефекти заклинань на цілі, чий рівень не перевищує рівень використаного слоту мани.';
...
export const haste_expanded = 'Виберіть згодну істоту, видиму в межах дистанції. Поки закляття активно, швидкість цілі подвоюється, вона отримує бонус +2 до Броні, вона здійснює з перевагою Випробування Спритності, і в кожному ході може здійснювати додаткову дію. Цією дією може бути лише Атака (одна атака зброєю), Засідка, Використання предмета, Відхід чи Ривок.<br/><br/>'+
...
'Якщо ціль родом із того плану існування, на якому перебуваєте ви, ви виганяєте її в безпечний деміплан. Перебуваючи там, ціль недієздатна. Вона залишається там, поки активно закляття, після чого повертається в простір, з якого зникла, або найближчий вільний простір, якщо місце зайняте.<br/><br/>'+
...
export const scrying_details = 'Створити сенсор спостереження поряд з ціллю, яка може переміщатися слідом за нею. Складність Випробування проти заклинання залежить від вашого знання цілі та фізичного звʼязку з її частиною:<br/>'+
...
'Вы знаете цель:<br/>'+
'• Через посредников (вы только слышали о цели): -5 до складності<br/>'+
'• Из первых рук (вы встречались с целью): +0 до складності<br/>'+
'• Знакомые (вы хорошо знаете цель): +5 до складності<br/><br/>'+

'У вас есть:<br/>'+
'• Образ или рисунок цели: +2 до складності<br/>'+
'• Вещь или одежда цели: +4 до складності<br/>'+
'• Часть тела цели — прядь волос, кусок ногтя ... : +10 до складності<br/><br/>'+
