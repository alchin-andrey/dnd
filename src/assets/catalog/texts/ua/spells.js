...
export const primeval_awareness_details = 'Визначити без деталей, чи є в межах дальності аберації, дракони, породження, небожителі, невмерлі, феї та елементали.';
...
'Поки закляття активне, ви захищені від певного виду істот: аберації, породження, небожителі, невмерлі, феї чи елементали.<br/><br/>' + 
