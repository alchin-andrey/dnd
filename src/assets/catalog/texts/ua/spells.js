...
export const primal_awareness_details = " Можна застосувати без мани 1 раз на день."

export const primal_awareness_expanded = "<br/><br/>Ви можете один раз застосувати кожне з цих заклинань без використання слотів мани. Як тільки ви використовуєте закляття таким чином, ви не зможете зробити це повторно до закінчення тривалого відпочинку."
