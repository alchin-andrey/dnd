...
'Якщо описана або названа вами істота знаходиться в іншому вигляді, наприклад під ефектом закляття Поліморф, це закляття не знайде цю істоту. Це закляття не може виявити істот, якщо прямий шлях між вами перерізаний поточною водою шириною щонайменше 10 футів.';
