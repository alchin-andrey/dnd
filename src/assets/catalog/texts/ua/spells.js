...
'Ви вказуєте пальцем, і істота, яка завдала вам пошкодження, миттєво оточується полумʼям. Істота має пройти Випробування Спритності. Вона отримує пошкождення вогнем 2d10 при провалі, або половину цього пошкодження при успіху.<br/><br/>' + once_a_day_expanded;
...
export const protection_from_evil_and_good_paladin_expanded = 'Ви завжди знаходитеся під ефектом заклинання Захист від зла та добра.<br/><br/>' + 
...
export const illusory_reality_expanded = 'Ви осягли секрети плетіння тіньових заклять, що робить ваші ілюзії наполовину реальними. Коли ви накладаєте заклинання Ілюзії 1 рівня або вище, ви можете вибрати будь-який неживий і немагічний обʼєкт, який є частиною цієї ілюзії, щоб зробити його реальним. Ви можете зробити це у свій хід Бонусною дією, поки діє заклинання. Обʼєкт стає реальним на 1 хвилину. Наприклад, ви можете створити ілюзію мосту через розлом і тримати його реальним досить довго, щоб ваші союзники могли по ньому перебратися. Обʼєкт не може завдавати шкоди або безпосередньо поранити будь-кого.';
