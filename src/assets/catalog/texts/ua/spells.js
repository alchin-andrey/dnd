...
'Фокус для створення закляття можна замінити на дрібку солі та по одній мідній монеті на кожне око трупа, які мають залишатися там весь час, поки закляття активне.';
...
'Фокус для створення закляття можна замінити на хутро кажана.';
