...
'Для виявлення того, що ви замасковані, істота повинна Основною дією обстежити вашу зовнішність і досягти успіху в перевірці Розслідування проти вашої Складності заклинань.';

export const hunters_mark = 'Мисливський знак';

export const hunters_mark_details = 'Додаткове пошкодження по вибраній істоті, а також <span class="buff">перевага</span> на його пошук. При ліквідаціі цілі можна Бонусною дією вибрати іншу істоту.';
...
export const detect_evil_and_good_expanded = 'Поки закляття активно, ви знаєте, чи є в межах 30 футів від вас аберації, породження, небожителі, нежить, феї або елементали, а також їхнє розташування. Крім того, ви знаєте, чи є в межах 30 футів від вас місце або предмет, який був магічно освячений або опоганений.<br/><br/>' + 
...
'Обплутана рослинами істота може дією здійснювати перевірки Сили проти Складності ваших заклинань. У разі успіху воно звільняється. Коли закляття закінчується, викликані рослини вʼянуть.';
...
export const ensnaring_strike_expanded = 'Коли ви наступного разу влучите атакою зброєю, поки закляття активне, в точці удару зʼявляється маса рослин, що звивається, з шипами, і ціль повинна досягти успіху у Випробуванні Сили, інакше вона стане обплутана магічними лозами, поки закляття активно.<br/><br/>' + 
...
'Обплутана істота або істота, здатна торкнутися її, може Основною дією перевірити Силу проти Складності ваших заклинань. За успіху ціль звільняється.<br/><br/>' + 
'Якщо ви накладаєте це закляття, використовуючи слот 2 рівня або вище, пошкодження збільшується на 1d6 за кожен рівень слоту вище за перший.';
