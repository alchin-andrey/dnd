...
export const searing_smite_details = 'Наступне ваше ближнє влучення підпалює ціль. Вогонь завдає цілі пошкодження кожен хід, якщо вона провалює Випробування.';
...
'• Не може атакувати, але може бути джерелом заклинань';
