...
'Копіювання заклинання у вашу книгу включає відтворення основної форми заклинання, а також розшифровку унікальної системи позначень, яку використовує чарівник, який записав його. Ви повинні підібрати потрібні жести та звуки, після чого записуєте його у свою книгу заклять, використовуючи власні позначення.<br/><br/>'+
...
'Ви можете збільшити силу своїх найпростіших заклинань. Створюючи заклинання чарівника, що завдає пошкодження, з 1 по 5 коло, ви можете завдати максимальне пошкодження.<br/><br/>'+
'Без шкоди для себе Ви можете використати це вміння один раз. Якщо Ви повторно використовуєте це вміння до закінчення довгого відпочинку, то отримуєте шкоду некротичною енергією 2к12 за кожне коло заклинання відразу після створення. Кожен наступний раз, при використанні даного вміння до закінчення довгого відпочинку, шкода некротичною енергією збільшується на 1к12. Ця шкода ігнорує опір та імунітет.';
...
'• Ви не можете накладати закляття, а промови та дії, що вимагають рук, можуть бути обмежені видом звіра. Перетворення не перериває вашу концентрацію на вже створених закляттях і не заважає робити дії, які є частиною заклинання, такі як у разі заклинання Виклик Блискавки.<br/><br/>'+
...
export const learn_tool = "Знання століть";
