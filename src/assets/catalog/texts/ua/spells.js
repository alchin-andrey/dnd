...
'Якщо істота в межах 30 футів від вас робить кидок атаки, ви можете Реакцією надати цій суті бонус +10 до кидка, використовуючи Божественний канал. Ви можете вирішити, чи застосовувати це вміння, після того, як побачите результат кидка, але до того як Майстер скаже, потрапила атака або промахнулася.';
...
'Ви можете використовувати Божественний канал, щоб закликати сонячне світло, що проганяє темряву і завдає шкоди випромінюванням ворогам. Ви дією демонструєте свій священний символ, і вся магічна темрява в межах 30 футів від вас розсіюється.<br/><br/>' + 
...
export const eldritch_blast_slow_expanded = 'Один раз у кожному з ваших ходів, коли ви потрапляєте по суті Містичним зарядом, ви можете до кінця наступного ходу зменшити його швидкість на 10 футів.';
