...
export const shield_block_details = 'При успішному Випробуванні Спритності, повністю відбити пошкодження від заклинання.';
...
'Заклинання дає згодній істоті, до якої ви доторкнулися, здатність бачити речі такими, якими вони є насправді. Поки закляття активне, ця істота має істинний зір, бачить потаємні двері, приховані магією, його зір простягається на Ефірний План, і все це в межах 120 футів.<br/><br/>'+
...
export const power_word_kill_expanded = 'Ви вимовляєте слово сили, що змушує істоту, яку ви бачите в межах дистанції, миттєво померти. Якщо у вибраної вами істоти не більше 100 хітів, вона вмирає. В іншому випадку це заклинання не має жодного ефекту.';
