...
export const primeval_awareness_details = 'Визначити без деталей, чи є в межах дальності аберації, дракони, породження, небожителі, немертві, феї та елементали.';
...
'Поки закляття активне, ви захищені від певного виду істот: аберації, породження, небожителі, немертві, феї чи елементали.<br/><br/>' + 
...
export const otilukes_resilient_sphere = "Пружна куля Отилюка";
