...
export const divine_channel_expanded = 'Це закляття використовує Божественний канал. Він доступний для використання один раз на короткий відпочинок.';
