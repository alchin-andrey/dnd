...
export const flaming_sphere_expanded = 'У вільному просторі на ваш вибір в межах дистанції зʼявляється куля з вогню діаметром 5 футів, існуюча, поки активно закляття. Всі істоти, що закінчують хід у межах 5 футів від кулі, повинні пройти Випробування Спритності. Істоти отримують пошкодження Вогнем 2d6 при провалі або половину цього пошкодження при успіху.<br/><br/>' +  
...
export const blur_expanded = 'Ваше тіло стає розмитим і хитається для всіх, хто бачить вас. Поки закляття активно, всі істоти роблять по вам кидки атаки з перешкодою. Атакуючий отримує імунітет до цього ефекту, якщо покладається не на зір, а, наприклад, сліпий зір, або може бачити крізь ілюзії, наприклад, за допомогою істинного зору.';

export const heat_metal = 'Розпекти метал';
...
'Зміна зовнішності. Ви змінюєте свою зовнішність. Ви самі вирішуєте, на кого бути схожим, включаючи зріст, вагу, обличчя, звук голосу, довжину волосся, кольори та особливі характеристики. Ви можете стати схожим на представника іншої раси, але ваші показники не змінюються. Ви також не можете виглядати як істота іншої категорії розміру, і ваше тіло залишається приблизно тим самим; наприклад, це закляття не зробить вас чотириногим. Поки закляття активне, ви можете Основною дією змінювати свою зовнішність.';

export const darkvision = 'Темний зір';

export const darkvision_details = 'Дати істоті можливість бачити у темряві на 60ф.';

export const darkvision_expanded = 'Ви торкаєтеся приголосної істоти і даруєте їй можливість бачити у темряві. Поки закляття активно, ця істота має темний зір у межах 60 футів.<br/><br/>' +  
...
'Зменшення. Розміри цілі зменшуються вдвічі за всіма вимірами, а вага зменшується до однієї восьмої від звичайного. Це зменшує розмір однією категорію — від Середнього до Маленького, наприклад. Поки закляття активно, ціль здійснює з перешкодою перевірки та Випробування Сили. Зброя цілі також зменшується. Атаки зменшеною зброєю завдають на 1d4 менше пошкодження (не може бути меншим за 1).<br/><br/>' +  
...
export const enhance_ability = "Покращення характеристики";
