...
'Атмосфера під ним суха і комфортна, хоч би якою була погода зовні. Поки закляття активно, ви можете зробити простір під ним тьмяно освітленим або зануреним у темряву.<br/><br/>'+
...
export const major_image_expanded = 'Ви створюєте образ предмета, істоти або іншого видимого явища, що міститься в обʼємі в куб із довжиною ребра 20 футів. Образ зʼявляється в точці, яку ви бачите в межах дистанції, і існує, поки активне заклинання.<br/><br/>'+
...
'Фізична взаємодія з образом дає зрозуміти, що це ілюзія, тому що крізь неї все проходить. Істоти, що досліджують образ дією, можуть визначити, що це ілюзія, зробивши успішну перевірку Аналізу проти складності ваших заклинань. Якщо істота розпізнає ілюзію, вона може бачити крізь неї, і всі інші сенсорні ефекти ілюзії теж притуплюються.<br/><br/>'+

'Якщо ви накладаєте це заклинання, використовуючи слот 6 рівня або вище, воно триває, поки не розсіється, не вимагаючи від вас концентрації.';