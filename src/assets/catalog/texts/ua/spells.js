...
export const hunger_of_hadar_details = 'Створити область темряви і кошмару, що робить місцевість важкопрохрдимою, що засліплює і завдає пошкодження Холодом істотам, що починають хід в області. Також завдає пошкодження Кислотою, тим хто закінчує хід в області і провалили Випитування.';
...
'Якщо ви накладаєте це закляття, використовуючи слот 4 рівня або вище, тривалість збільшується на 1 годину за кожен рівень слоту вище за третій.';