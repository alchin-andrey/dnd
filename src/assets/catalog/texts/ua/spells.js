...
'Завадити істоті в атаці / утраті / Випробуванні.';
...
'Завдати додаткове пошкодження при влучанні зброєю.';

export const divine_strike_nature_details = 
'Завдати додаткове пошкодження 🔥 Вогнем | ❄️ Холодом | ⚡️ Струмом при влучанні зброєю.';
...
export const eldritch_blast_slow_details = 'Ваш Містичний заряд сповільнює ціль на 10ф.';
...
export const entropic_ward = 'Ентропічна опіка';
...
'Ви можете тримати одночасно тільки одну істоту під дією Тремтячої долоні. Ви можете вирішити закінчити коливання без шкоди, не витрачаючи Основну дію.';
...
export const enemy_killer_details = 'Бонусне пошкодження по обраним ворогам | противникам.';
...
export const horde_breaker_details = 'При атаці, атакувати ще одну істоту поряд з ціллю.';
...
export const giant_killer_details = 'Атакувати видиме вами Велику істоту у відповідь.';
