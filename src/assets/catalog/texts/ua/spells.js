...
export const cone_of_cold_monk_expanded = 'З ваших рук виривається хвиля холодного повітря. Всі істоти в 60-футовому конусі повинні пройти Випробування Статури. Істоти отримують пошкодження холодом 8d8 при провалі, або половину цього пошкодження при успіху. Істоти, вбиті цим закляттям, стають замороженими статуями, доки не розтануть.';