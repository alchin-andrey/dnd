...
export const gaseous_form_monk_expanded = 'Ви перетворюєте на час дії заклинання себе, а також все, що ви тримаєте і носите, на туманну хмару.<br/><br/>'+
'Заклинання закінчується, якщо ваше здоровʼя опускається до 0. Поки ви знаходитесь в цій формі, єдиною вашою швидкістю переміщення стає швидкість польоту 10 футів. Ви можете входити в простір інших істот і залишатися там. Ви не можете атакувати і накладати заклинання.<br/><br/>'+
