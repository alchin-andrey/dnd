...
export const create_thrall_expanded = 'Ви отримуєте здатність інфікувати розум гуманоїдів чужорідною магією свого покровителя. Ви можете Основною торкнутися недієздатного гуманоїду. Ця істота стає Зачарованою вами до тих пір, поки на неї не буде створено заклинання Зняття прокляття, або поки вона не перестане бути Зачарованою, або поки ви не використовуєте це вміння ще раз. Ви можете спілкуватися телепатично із зачарованою істотою, поки ви обидва перебуваєте на одному плані існування.';
