...
export const circle_of_the_land_arctic = "Круг землі: Тундра";
export const circle_of_the_land_arctic_details = circle_of_the_land_details +
'<br /><br />Причетність до кола Землі наділяє магію друїда силою тих місць, де персонажа посвятили у священні обряди. Для вас це крижана тундра.</p>';

export const circle_of_the_land_coast = "Круг землі: Узбережжя";
export const circle_of_the_land_coast_details = circle_of_the_land_details +
'<br /><br />Причетність до кола Землі наділяє магію друїда силою тих місць, де персонажа посвятили у священні обряди. Для вас це камʼянисте узбережжя.</p>';

export const circle_of_the_land_desert = "Круг землі: Пустеля";
export const circle_of_the_land_desert_details = circle_of_the_land_details +
'<br /><br />Причетність до кола Землі наділяє магію друїда силою тих місць, де персонажа посвятили у священні обряди. Для вас це пекуча пустеля.</p>';

export const circle_of_the_land_forest = "Круг землі: Ліс";
export const circle_of_the_land_forest_details = circle_of_the_land_details +
'<br /><br />Причетність до кола Землі наділяє магію друїда силою тих місць, де персонажа посвятили у священні обряди. Для вас це густій ліс.</p>';
...
'<p>Архетип мисливця означає визнання свого місця як оплоту між цивілізацією та жахами диких земель. Якщо ви пішли шляхом мисливця, ви навчаєтеся спеціалізованим технікам ведення бою з погрозами, що зустрічаються вам, починаючи з шалених огрів і ордами орків, і закінчуючи велетнями і жахливими драконами.</p>';
