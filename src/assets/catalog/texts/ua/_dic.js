...
export default {
  ...
  authors:
    ...
    '<br /><p>Безжальне та жорстоке вторгнення ₚосії в Україну триває, тому 80% донатів ми відправляємо у фонд "<a target="_blank" href="https://savelife.in.ua">Повернись Живим</a>".</p>',
  ...
  responsive_top: "Нашому сайту потрібно трохі більше простору для найкращого досвіду, окрема мобільна версія ще у розробці.",
  responsive_bottom: "Спробуй відкрити на екрані більшого розміру і не пожалкуєш 🙃",
};
