...
//Заклинания — активньіе умения с уроном
    ...
    clothes_details: "Комплект одягу, що призначений для повсякденного носіння. Комплект включає в себе холшовую сорочку, штани, черевики або плетене з лози взуття.",
    ...
    '<br/><br/>Життя у злиднях залишає свій відбиток на безпритульних. У них, як правило, сильна прихильність до людей, з якими вони ділили тяготи вуличного життя, або вони сповнені бажанням досягти кращої долі, і, можливо, розквитатися з багатіями, яких вони натерпілися.'+
    ...
    for_team_in_city: "поза боєм в містах, для вас та відомих союзників",
    ...
    among_nobelty_and_good_treatment: "у вищому суспільстві, більшість дверей для вас відчинені",
    ...
    back_guild_artisan_details: "Ви — член гільдії ремісників, купців, караванників або крамарів, знавець у якійсь галузі, пов'язаний з іншими майстровими. Ви міцно стоїте на ногах у цьому торговому світі, відокремлені своїм талантом і багатством від кайданів феодального ладу.",
    back_guild_artisan_expanded: 
    '<br/><br/>Колись ви вчилися у майстра під опікою гільдії, і ось ви самі стали таким умільцем. Або ви самі ви нічого не майструєте, але заробляєте на життя, купуючи і продаючи твори чужих рук (або сировину, необхідну ремісникам).'+
    ...
    '<br/><br/>Моряки бувають грубими, але на їхніх плечах лежить тягар відповідальності за збереження життя екіпажу, тому на них можна покластися. Життя, проведене на кораблі, формує їхні погляди та найважливіші звички.'+
    ...
    back_sage_expanded: 
    '<br/><br/>Мудрецями стають після тривалих занять, і їх особистість відображає життя у постійному навчанні. Будучи в постійному пошуку мудрості, вони високо цінують знання як для себе, так і в прагненні до ідеалів.',
    ...
    '<br/><br/>Народний герой — один із простолюдинів, як у хорошому розумінні, так і в поганому. Багато хто з них вважає своє походження позитивною стороною, а не вадою, і їхнє рідне поселення залишається назавжди дуже важливим для них.',
    ...
    '<br/><br/>Злочинці на перший погляд можуть виглядати лиходіями, і багато хто з них справді злий. Але в деяких є такі риси, за які їх можна пробачити. Навіть серед злодіїв є честь, але злочинці рідко ставляться з повагою до влади та їх представників.',
    ...
    '<br/><br/>Ви посередник між царством небесним і миром живих. Ви робили священні ритуали і приносили жертви для того, щоб молящі могли постати перед лицем богів. Ви не обовʼязково клірик — здійснення священних обрядів не те саме, що напрямок божественної сили.'+
    ...
    '<br/><br/>Скільки памʼятаєте, у вашому житті завжди була війна. Жахи війни разом із жорсткою дисципліною військової служби залишають сліди усім солдатам, формуючи їх ідеали, створюючи прихильності, і навіть залишаючи ними шрами, як фізичні, і ментальні.'+
    ...
    '<br/><br/>Ви виросли в глушині, далеко від цивілізації та її благ. Ви бачили міграцію стад, чий розмір був більший за ліс, виживали при температурі, яку городянам і не уявити, і насолоджувалися таким усамітненням, що на багато миль навколо ви були єдиною розумною істотою.'+
    ...
    '<br/><br/>Ви знаєте, що люди хочуть, і ви даєте їм це, або обіцяєте дати. Почуття здорового глузду має змушувати людей триматися подалі від тих речей, які надто добре звучать, щоб бути правдою. Але здоровий глузд кудись випаровується, коли ви неподалік.'+
    ...
    back_spy_expanded: 
    '<br/><br/>Цілком можливо, що ви офіційно уповноважений агент корони, або ж ви просто продаєте добуті відомості тому, хто більше заплатить.',
    ...
    travelers_clothes_details: "Комплект одягу призначений для мандрівок. До нього входить сорочка, шкіряні чоботи, штани, рукавички, плащ із капюшоном.",
    ...
    silk_rope_details: "зроблена з шовку. Вона має 2 здоровʼя, і її можна порвати Випробуванням Сили складністю 17.",

    talisman_sailor: "талісман",
    talisman_sailor_details: "кроляча лапка або камінь з діркою",

    letter_question: "лист із питанням",
    letter_question_details: "лист від мертвого колеги з питанням, на яке ви поки що не можете відповісти",
    ...
    trophey_details: "трофей з убитого ворога (кинджал, зламаний клинок або шматок прапора)",

    staff: "посох",
    staff_details: "Особливий посох — створений для проведення таємних заклять. Чарівники, чаклуни та чародії можуть використовувати ці предмети як фокусування для заклинань",

    trophey_animal: "трофей з тварини",
    trophey_animal_details: "трофей з убитої тварини",

    hunting_trap: "капкан",
    hunting_trap_details: "Якщо ви Основною дією встановите цю пастку, вона утворює сталеве кільце із зазубреними краями, яка захлопується, коли в її центр настає істота. Капкан прив'язується товстим ланцюгом до нерухомого предмета, такого як дерево або кілочок, убитий у землю. Істота, що наступила в центр, повинна досягти успіху у Випробуванні Спритності зі Складністю 13, інакше вона отримує колоте пошкодження 1d4 і припиняє переміщення. Згодом, доки істота не вивільниться з пастки, її переміщення обмежені довжиною ланцюга (зазвичай 1 метр). Будь-яка істота може здійснити перевірку Сили зі Складністю 13, щоб звільнити себе або іншу істоту, яка знаходиться в межах досяжності. Кожна провалена перевірка завдає спійманій суті колоте пошкодження 1.",

    tool_forgery:"фальсифікації",

    trick_set: "шарлатанський предмет",
    trick_set_details: "пристрій для шахрайства на ваш вибір (десять запечатаних пляшок з підфарбованою рідиною, набір шулерських кубиків, колода краплених карт або кільце з печаткою якогось уявного герцога)",

    androginsexual:"Андрогінсексуал",
    androginsexual_details:"ваш персонаж має тяжіння до істот з яскраво вираженими чоловічими та жіночими рисами одночасно.",
    pansexual:"Пансексуал",
    pansexual_details:"ваш персонаж має тяжіння до істот незалежно від гендера.\n\n",
    polysexual:"Полісексуал",
    polysexual_details:"ваш персонаж має тяжіння до декількох гендерів.\n\n",
    androsexual:"Андросексуал",
    androsexual_details:"ваш персонаж має тяжіння до істот з яскраво вираженими чоловічими рисами.",
    bisexual:"Бісексуал",
    bisexual_details:"ваш персонаж має тяжіння до чоловіків та жінок.\n\n",
    ginsexual:"Гіносексуал",
    ginsexual_details:"ваш персонаж має тяжіння до істот з яскраво вираженими жіночими рисами.",
    ...
    sapiosexual_details:"ваш персонаж має тяжіння до інтелекту, незалежно від гендера.",
    ...
    taler: "оповідач",
          ...
          obscene: "вульгарний",
          toxic: "токсичний",
          coldblooded: "холоднокровний",
          schemer: "махінатор",
          conspirator: "конспіролог",
          fatalist: "фаталіст",
          philosopher: "філософ",
          erudite: "ерудит",
          wise: "мудрий",
          ...
          silent: "мовчазний",
          closed: "закритий",
          unsociable: "нелюдимий",
          injured: "травмований",
          anxious: "тривожний",
          Incredulous: "недовірливий",
          vindictive: "злопамятний",
          vengeful: "мстивий",
          irascible: "запальний",
          harmful: "шкодний",
          cunning: "хитрий",
          approach: "підступний", // підступний
          cruel: "жорстокий",
          pitiless: "безжальний",
          rectilinear: "прямий",
          rude: "грубий",
        ...
        commitment: "прихильність",
          ...
          idol: "кумир",
          artifact: "артефакт",
          structure: "сакральна споруда",

    
        secret: "секрет",
          // Секрети
          mistake: "жахлива помилка", // "жахлива помилка",
          setup: "підстава",
          crime: "злочин",
          trait: "зрада",
          owe: "борг",
          shame: "ганьба",
          exile: "вигнання",
          follower: "переслідувач",
          sick: "хвороба",
          pact: "рокова угода",
          target: "замовлення",
          plans: "підступні плани",
          prophesy: "пророцтво",
        ...
        weakness: "слабкість",
          ...
          wrath: "гнів",
          envy: "заздрість",
          submissiveness: "покірність",
          dependance: "залежність",
          spender: "марнотратство",
          belief: "довірливість",
          carelessness: "необачність",
          recklessness: "нерозсудливість",
