...
export default {
  ...
  authors:
    ...
    "<br /><p>З будь яких тем по цьому сайту, пишіть Дімі.</p>" +
  ...
  lobby_what_is_it: "Що воно таке?",
  
  lobby_what_is_it_details: 
  'На відміну від сюжетних компʼютерних ігор, гравці у Dungeons & Dragons можуть робити дійсно ЩО ЗАВГОДНО і впливати на світ гри, створюючі непередбачувані ситуаціі та неочікувані наслідки. Все, як в житті 😂'+
  
  '<br/><br/>Сюжети, типові або авторські, оффлайн та онлайн, є такі:'+
  
  '<br/><br/>One-shot — Коротка історія на 1-2 гри. Як от <a target="_blank" href="https://youtu.be/GY6AZbLfxmQ?t=185">Штольні&nbsp;Божевілля,&nbsp;від&nbsp;idearoll</a>.'+
  
  '<br/><br/>Module — Середня історія, яку можна грати протягом кількох сеансів, зазвичай 3-5 ігор. Наприклад <a target="_blank" href="https://youtu.be/7CjvWO05rA0?t=507">Подвійна&nbsp;Гра,&nbsp;від&nbsp;Dice&Bones</a>.'+
  
  '<br/><br/>Campaign — Довготривала історія, яка може тривати кілька місяців або навіть років. Ось як це робить команда <a target="_blank" href="https://youtu.be/P8pLvV3FjPc?t=756">Critical&nbsp;Role</a>&nbsp;(EN).'+
  
  '<br/><br/>Вдалий ваншот легко може перетворитися на Модуль, або навіть на Кампейн.'+
  
  '<br/><br/>D&D здатна сподобатися кожному. Це доводить її всесвітня популярність протягом вже 50+ років, не зважаючи на складність початку (до появи нашого сайту).',

  lobby_how_it_works: "Як проходить гра?",

  lobby_how_it_works_details_1: "Ви обираєте Майстра та звʼязуєтеся з ним",
  lobby_how_it_works_details_1_1: ", домовляєтеся по&nbsp;часу, місцю, кількості людей від вас та ін. Зазвичай це 3-4 людини та 3-4 години.",

  lobby_how_it_works_details_2: "Майстер формує группу, та каже якого рівня треба створити персонажа. Зазвичай це 3й.",
  lobby_how_it_works_details_3: "Ви заздалегідь створюєте свого персонажа та відправляєте його Майстру.",
  
  
  lobby_how_it_works_details_4: "Майстер розповідає основи, просить гравців трохи розповісти про своїх персонажів та починає занурювати вас у сюжет.<br/><br/>——",
  
  lobby_how_it_works_details_5: "Майстер описує оточення та ситуацію.",
  
  lobby_how_it_works_details_6: "Гравці, взаємодіючи між собою (або ні), кажуть що вони хочуть зробити/сказати їх персонажі.",
  
  lobby_how_it_works_details_7: "Майстер загадково усміхається, просить кинути конкретні кубики, та на основі результату кидка описує наслідки, з&nbsp;яких&nbsp;виходить нова ситуація для реакції гравців.",

  lobby_masters: "майстри",
  ...
  print_biography_details: "Біографія дозволяє гравцю краще зрозуміти свого персонажа та його мотивацію, а також допомагає імпровізувати в ході гри та створювати більш реалістичний світ. <br/><br/>Придумайте деталі про дитинство, родину персонажа, його досвід та навички, складнощі та виклики, переживання та травми, успіхи та поразки, цілі та мету — все, що може впливати на поведінку персонажа. Не бійтеся включати незвичайні або непопулярні деталі, що можуть робити персонажа більш цікавим та “живим”. <br/><br/>Пам'ятайте, що біографія персонажа — це лише початок, і персонаж може еволюціонувати протягом гри, тому не бійтеся змінювати його характер та мотивацію, якщо це відбувається в ході історії."
};
