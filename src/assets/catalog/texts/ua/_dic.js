...
export default {
  ...
  authors:
    ...
    '<br /><p>Якщо у вас є бажання задонатити, будемо дуже вдячні. Ми плануємо розвивати проект та додавати новий функціонал. Безжальне та жорстоке вторгнення ₚосії в Україну триває, тому 80% донатів ми відправляємо у фонд "<a target="_blank" href="https://savelife.in.ua">Повернись Живим</a>".</p>',
