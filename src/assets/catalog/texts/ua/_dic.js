...
export default {
  ...
  welcome_message:
    "Щоб повноцінно грати в D&D, достатньо придумати персонажа потрібного рівня, а решту влаштує ваш Майстер. Цей чарівний сайт допоможе вам створити персонажа за 3 простих кроки:\nРаса, Клас та Типаж.\n\nНайкращий підхід для першого разу — розслабитися і вибирати за покликом серця. Тут немає неправильних рішень. У фіналі ви отримаєте аркуш персонажа, з яким ви зможете розпочати гру!",
  welcome_disclaimer:
    '<br /><p>Матеріали на цьому сайті не змінюють необхідності придбання офіційних матеріалів. Cистема Dungeons & Dragons є власністю корпорації Wizards of the Coast, графічні матеріали створені за допомогою <a target="_blank" href="https://www.heroforge.com">Hero Forge ↗</a></p>',
  ...
  skills: "навички",
  skills_details:
    "Значення Навичок — основні показники, що використовуються в грі. Підсумкові значення будуть вираховані після вибору Класу на кроці 2 та Типажу на кроці 3.",
  ...
  feat_magic_initiate_details_cleric:
    "Ви знаєте два закляття жреця, що не потребують мани, і одне заклинання, що вимагає 1 ману (його ви можете використовувати без мани, але накладати його на мінімально можливому рівні, і один раз між тривалими відпочинками).",
  ...
  no_mana_but_ritual:
    "Ви зможете використовувати обране закляття без мани, але накладати його на 10 хвилин довше і тримаючи в руці свою ритуальну книгу.",
  ...
  feat_ritual_caster_details_cleric:
    "Ви дізнаєтесь два ритуали жреця. Ви зможете використовувати їх без мани, але накладати його на 10 хвилин довше і тримаючи в руці свою ритуальну книгу. Також ви можете вивчати інші знайдені ритуальні закляття жреця.",
  ...
  intelligence_aberrations_against:
    "на перевірки Інтелекту, пов'язані з аберрациями",
