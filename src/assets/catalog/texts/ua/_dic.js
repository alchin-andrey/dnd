...
export default {
    ...
    //Стартовое
            ...
            welcome_disclaimer: 'Матеріали на цьому сайті не змінюють необхідності придбання офіційних матеріалів. Cистема Dungeons & Dragons є власністю корпорації Wizards of the Coast, графічні матеріали створені за допомогою <a href="https://www.heroforge.com">Hero Forge ↗</a>.',

            authors: 
            '<a href="https://t.me/dimalagoda">@ Dima Lagoda, Product Designer</a> — ідея, дизайн, контент,' +
            '\n<a href="https://t.me/Ki3iL">@ Andrii Alchin, Frontend Developer</a> — код,' +
            '\n<a href="https://t.me/godblessdnd">@ Andrii Pavlov, Лучший Мастер</a> - переклади, валідація.' +
            '\nЗ будь яких тем по цьому сайту, пишіть Дімі.' +
            '\n\nЯкщо у вас є бажання задонатити, будемо дуже вдячні. Безжальне та жорстоке вторгнення ₚосії в Україну триває, тому 80% донатів ми відправляємо у фонд "<a href="https://savelife.in.ua">Повернись Живим</a>".',
