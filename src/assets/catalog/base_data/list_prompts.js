export default {
  ...
  bio: {
    ...
    prompt: "Write detailed D&D char bio using the attributes provided. It is whole, consistent, and has non-standard but reasonable cause and effect relationship for each phase, person, event, place, for difficulties, challenges, experiences, traumas, successes, failures, goals, purpose etc. 3rd-person voice, past to present. Less poetic, more straight forward. More specific names, events and toponyms. Description of gender, level and alignment is indirect. Weave motivations, relationships, secrets and a signature quirk. Keep it generic but vivid. End with a one-sentence adventure hook, integrated in the story. Lang - UA. 7 long paragraphs, about 700 letters each.", //add dic name?
