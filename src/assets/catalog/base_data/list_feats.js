...
export default {
        ...
        list: [
          {
            ...
            settings: [
              ...
              },
              {
                ...
                // вьіберите одно заклинание 1 уровня из єтого же списка. Вьі узнаете єто заклинание и можете накладьівать его на минимально возможном уровне. После использования заклинания вьі должньі закончить продолжительньій отдьіх, прежде чем сможете снова использовать его єтой чертой.
                //TODO - custom spell attribute
                //Базовая характеристика для єтих заклинаний зависит от вьібранного класса:
  ...
  ritual_caster: {
    ...
    //Требования: Интеллект или Мудрость 13 или вьіше
        ...
        list: [
          {
            ...
            settings: [
              {
                // TODO - Apply alterations
                // Вьі узнали несколько заклинаний, которьіе можете накладьівать как ритуальі. Вьібранньій класс также определяет базовую характеристику для єтих заклинаний: Харизма для барда, колдуна и чародея; Интеллект для волшебника; Мудрость для друида и жреца.
                type: "custom",
                name: "spells_1",
