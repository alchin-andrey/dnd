		...
		<main class="w-100">
			<div v-if="!screen_Max" class="mob-header flex-col-c-jc">
				<div class="flex-row-sb-c pd-rl-20">
					...
					<AppBtmLink class="int-700 btm-blue w-200" @click="goToChar()" name="how_to_start_2_title" />
				</div>
			</div>
			...
			<section class="welcom-wrapp">
				<div class="h-100">
					<div class="welcom-content">
						...
						<WelcomPage__Masters id="welcom-part5" ref="masters_part" class="mr-t-76 pd-t-32" />
...
export default {
	...
	mounted() {
		if (this.welcome_page.hash) {
			this.scrollMeTo(this.welcome_page.hash);
		}
	},

	computed: {
		...mapState(usePagesStore, ["screen_Max", "welcome_page"]),
	},
